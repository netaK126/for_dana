...
function parse_commandline()
    ...
    @add_arg_table! s begin
        ...
        arg_type = String
        required = false
        default = "/root/Downloads/vaghar_org/results/63904073920847_4x10_linf_0.02_ctag0_itr17_cTag1.txt"
        #"/root/Downloads/vaghar_org/results/63904068084000_4x10_linf_0.02_ctag0_itr18_cTag1.txt"
        "--string_for_name"
        help = "the path to the original model i want to check the delta_diff with"
        arg_type = String
        required = false
        default = "CtargetVersion_itr18vs17_Reversed_"
    end
    return parse_args(s)
end
...
function main()
    margin_list = [0.00001]#[1, 0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001]
        ...
        for dep in deps
            ...
            for c_tag in c_tags
                for c_target in c_targets
                    ...
                    println("model_path1 = "*model_path1)
                    nn1 = get_nn(model_path1, model_type1, w, h, k, c, dataset)
                    println("model_path2 = "*model_path2)
                    ...
                    mip_set_delta_diff_property_neta(m, d,delta1_vaghar, c_tag, c_target, true, margin)
                    ...
                    save_results(results_path, "margin"*string(margin)*"DifferentEncodingForPerturbationInObjective_deltaDiff_"*depstring*"_"*string_for_name*"_"*model_type1*"_"*model_type2, results.str, d, nn1, c_tag-1, "None", w, h, k,model_name_in_path)
                end
            end
        end
    end
