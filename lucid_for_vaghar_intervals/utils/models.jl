...
function get_nn_hyper(model_path, model_name, dim, c, dataset, chunks = 0)
    ...
    if occursin("3x",model_name)
        ...
        fc1 = get_hyper_network_params(dicto, "fc1", (dim, layers_n))
        deps1In = get_hyper_network_deps_paramsIn(dicto, "fc1", (layers_n, layers_n))
        deps1 = get_hyper_network_deps_params(dicto, "fc1", (layers_n, layers_n))
        fc2 = get_hyper_network_params(dicto, "fc2", (layers_n, layers_n))
        deps2In = get_hyper_network_deps_paramsIn(dicto, "fc2", (layers_n, layers_n))
        deps2 = get_hyper_network_deps_params(dicto, "fc2", (layers_n, layers_n))
        fc3 = get_hyper_network_params(dicto, "fc3", (layers_n, c))
    ...
    elseif occursin("4x",model_name)
        ...
        deps2 = get_hyper_network_deps_params(dicto, "fc2", (layers_n, layers_n))
        fc3 = get_hyper_network_params(dicto, "fc3", (layers_n, c))
        deps3In = get_hyper_network_deps_paramsIn(dicto, "fc3", (layers_n, layers_n))
        deps3 = get_hyper_network_deps_params(dicto, "fc3", (layers_n, layers_n))
        fc4 = get_hyper_network_params(dicto, "fc4", (layers_n, c))
