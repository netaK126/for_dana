...
% auto-generated: archs=[cnn1=44combos/779cells(timeout-combos=14), 3x50=24combos/513cells(timeout-combos=58), 3x10=40combos/666cells(timeout-combos=0)], seed=None, tau=None, combo_filter=zono:prev_pgd:0.0+sg,zono:prev_pgd:0.5+sg
\begin{table}[!htbp]
\centering
\scriptsize
...
\hline
\rowcolor{blue!12}   1 & zono        & prev\_pgd & 0.0+sg & \textbf{1.224} &   183 &    316 & \textbf{57.91\%} & \textit{none} & \texttt{<3x10,\discretionary{}{}{}1>}; \texttt{<3x50,\discretionary{}{}{}2>}~\textit{(tied at TIME\_LIMIT)}; \texttt{<3x50,\discretionary{}{}{}0>}~\textit{(tied at TIME\_LIMIT)} \\
\hline
\rowcolor{blue!12}   2 & zono        & prev\_pgd & 0.5+sg & \textbf{1.281} &   185 &    322 & \textbf{57.45\%} & \textit{none} & \texttt{<cnn1,\discretionary{}{}{}1>}; \texttt{<3x50,\discretionary{}{}{}1>}~\textit{(tied at TIME\_LIMIT)}; \texttt{<3x50,\discretionary{}{}{}2>}~\textit{(tied at TIME\_LIMIT)}; \texttt{<3x50,\discretionary{}{}{}0>}~\textit{(tied at TIME\_LIMIT)} \\
\hline
\end{tabular}%
\end{adjustbox}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{cnn1} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=105$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,2.08\,(2/2) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.95\,(2/2)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.945);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.945);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.995) {1.95};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,2.081);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.081);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,2.131) {2.08};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,3.13) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{cnn1} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=105$ cells, $n_{\max}=53$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,64\%\,(34f+0t/53) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,63\%\,(33f+0t/52)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=53$};
  \node[left, font=\tiny] at (0,0.75) {13};
  \node[left, font=\tiny] at (0,1.50) {26};
  \node[left, font=\tiny] at (0,2.25) {40};
  \node[left, font=\tiny] at (0,3.00) {53};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.943);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.943);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.868);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.868);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.963) {63\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.925);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.925);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {64\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,4.00) {$\bigstar$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=320$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.42\,(2/2) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.35\,(2/2)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.347);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.347);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.397) {1.35};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.424);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.424);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.474) {1.42};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,2.47) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=320$ cells, $n_{\max}=161$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,78\%\,(72f+53t/161) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,64\%\,(69f+33t/159)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=161$};
  \node[left, font=\tiny] at (0,0.75) {40};
  \node[left, font=\tiny] at (0,1.50) {80};
  \node[left, font=\tiny] at (0,2.25) {121};
  \node[left, font=\tiny] at (0,3.00) {161};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.963);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.963);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.286);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.286);
  \fill[white] (0.33,1.286) rectangle (0.78,1.901);
  \fill[blue!75!black, opacity=0.25] (0.33,1.286) rectangle (0.78,1.901);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,1.286) rectangle (0.78,1.901);
  \draw[gray!50!black, line width=0.2pt] (0.33,1.286) rectangle (0.78,1.901);
  ...
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.342);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.342);
  \fill[white] (1.02,1.342) rectangle (1.48,2.329);
  \fill[red!75!black, opacity=0.25] (1.02,1.342) rectangle (1.48,2.329);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.342) rectangle (1.48,2.329);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.342) rectangle (1.48,2.329);
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{ALL} (p\_sizes merged: \texttt{0.1}, \texttt{1,14,14,3}, \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=638$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.28\,(4/4) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.22\,(4/4)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.224);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.224);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.274) {1.22};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.281);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.281);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.331) {1.28};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,2.33) {$\bigstar$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{ALL} (p\_sizes merged: \texttt{0.1}, \texttt{1,14,14,3}, \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=638$ cells, $n_{\max}=322$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,77\%\,(122f+126t/322) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,66\%\,(114f+93t/316)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=322$};
  \node[left, font=\tiny] at (0,0.75) {80};
  \node[left, font=\tiny] at (0,1.50) {161};
  \node[left, font=\tiny] at (0,2.25) {242};
  \node[left, font=\tiny] at (0,3.00) {322};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.944);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.944);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.062);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.062);
  \fill[white] (0.33,1.062) rectangle (0.78,1.929);
  \fill[blue!75!black, opacity=0.25] (0.33,1.062) rectangle (0.78,1.929);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,1.062) rectangle (0.78,1.929);
  \draw[gray!50!black, line width=0.2pt] (0.33,1.062) rectangle (0.78,1.929);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.964) {66\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  ...
  \fill[white] (1.02,1.137) rectangle (1.48,2.311);
  \fill[red!75!black, opacity=0.25] (1.02,1.137) rectangle (1.48,2.311);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.137) rectangle (1.48,2.311);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.137) rectangle (1.48,2.311);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {77\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,4.00) {$\bigstar$};
\end{tikzpicture}
...
% auto-generated: archs=['cnn1', '3x50', '3x10'], total_cells=702
\begin{table}[!htbp]
\centering
\small
...
11 & N2, zono, $\tau$=0.0, SibGate & \textbf{1.137} & 46 & 72 & \textbf{63.9\%} \\
12 & N2, zono, $\tau$=0.5, SibGate & \textbf{1.166} & 45 & 72 & \textbf{62.5\%} \\
13 & N2, zono, $\tau$=0.5 & \textbf{1.165} & 42 & 72 & \textbf{58.3\%} \\
14 & N2, no-zono, $\tau$=0.5, SibGate & \textbf{1.113} & 41 & 72 & \textbf{56.9\%} \\
15 & N2, no-zono, $\tau$=0.0, SibGate & \textbf{1.094} & 41 & 72 & \textbf{56.9\%} \\
16 & N2, zono, $\tau$=0.0 & \textbf{1.174} & 38 & 72 & \textbf{52.8\%} \\
\hline
\end{tabular}
...
% auto-generated: archs=['cnn1', '3x50', '3x10'], dataset=mnist, total_cell_rows=2582
\begin{table}[!htbp]
\centering
\scriptsize
...
\hline
\textbf{cnn1/N2} & linf (0.1) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 64.2 & 100.6 & 60.3 & --- & --- & --- & --- & --- & --- & 66.8 & 99.7 & 55.1 & --- & --- & --- & 59.6 & 101.9 & 59.3 & --- & --- & --- & 67.7 & 101.0 & 55.5 & 68.7 & 104.9 & 60.2 & 70.0 & 100.9 & 60.2 \\
...
dataset: \texttt{mnist} & occ (5,5,5) & 17.5 & 17.6 & 6.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 17.9 & 18.0 & 2.2 & 18.1 & 18.1 & 7.5 & --- & --- & --- & 18.1 & 18.1 & 6.7 & --- & --- & --- & 18.1 & 18.1 & 7.0 & --- & --- & --- & 18.1 & 18.1 & 6.9 & \cellcolor{green!25}18.1 & \cellcolor{green!25}18.2 & \cellcolor{green!25}1.4 & 18.2 & 18.9 & 7.8 \\
 ...
 & translation (1,1) & \cellcolor{green!25}98.9 & \cellcolor{green!25}99.8 & \cellcolor{green!25}6.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.6 & 99.6 & 16.0 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (1,3) & \cellcolor{green!25}99.1 & \cellcolor{green!25}99.9 & \cellcolor{green!25}4.9 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) & \cellcolor{green!25}98.8 & \cellcolor{green!25}99.6 & \cellcolor{green!25}6.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.7 & 99.7 & 17.1 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) & \cellcolor{green!25}98.6 & \cellcolor{green!25}99.5 & \cellcolor{green!25}9.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.2 & 99.4 & 24.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
\hline
...
dataset: \texttt{mnist} & occ (3,3,5) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.9 & 18.9 & 1.9 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.7 & 18.9 & 1.2 & \cellcolor{green!25}19.0 & \cellcolor{green!25}19.2 & \cellcolor{green!25}1.0 \\
 ...
 & translation (1,1) & \cellcolor{green!25}98.8 & \cellcolor{green!25}99.7 & \cellcolor{green!25}5.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.6 & 99.0 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) & \cellcolor{green!25}99.1 & \cellcolor{green!25}100.0 & \cellcolor{green!25}2.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.9 & 99.8 & 5.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}95.3 & \cellcolor{green!25}98.1 & \cellcolor{green!25}60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
\hline
...
dataset: \texttt{mnist} & patch (1,14,14,3) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 56.9 & 78.1 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}58.1 & \cellcolor{green!25}75.2 & \cellcolor{green!25}60.3 & 57.6 & 76.0 & 60.4 \\
 & translation (1,1) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}84.2 & \cellcolor{green!25}92.9 & \cellcolor{green!25}60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.2 & \cellcolor{green!25}97.6 & \cellcolor{green!25}20.0 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.9 & \cellcolor{green!25}15.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
\hline
...
dataset: \texttt{mnist} & patch (1,14,14,3) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 61.2 & 82.5 & 58.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}61.3 & \cellcolor{green!25}79.6 & \cellcolor{green!25}56.2 & 61.5 & 79.1 & 56.3 \\
 & translation (1,1) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}94.7 & \cellcolor{green!25}95.6 & \cellcolor{green!25}48.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.2 & \cellcolor{green!25}98.8 & \cellcolor{green!25}13.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.8 & \cellcolor{green!25}99.5 & \cellcolor{green!25}4.9 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
\hline
