...
% auto-generated: archs=[cnn1=50combos/888cells(timeout-combos=19), 3x50=30combos/594cells(timeout-combos=62), 3x10=46combos/774cells(timeout-combos=0)], seed=None, tau=None, combo_filter=zono:prev_pgd:0.0+sg,zono:prev_pgd:0.5+sg
\begin{table}[!htbp]
\centering
\scriptsize
...
\hline
\rowcolor{blue!12}   1 & zono        & prev\_pgd & 0.0+sg & \textbf{1.292} &   229 &    399 & \textbf{57.39\%} & \texttt{<3x10,\discretionary{}{}{}translation,\discretionary{}{}{}3,\discretionary{}{}{}3>}; \texttt{<3x10,\discretionary{}{}{}translation,\discretionary{}{}{}3,\discretionary{}{}{}1>} & \texttt{<3x10,\discretionary{}{}{}1>}\textsuperscript{*}; \texttt{<cnn1,\discretionary{}{}{}2>}\textsuperscript{*}; \texttt{<3x50,\discretionary{}{}{}2>}\textsuperscript{*}~\textit{(tied at TIME\_LIMIT)}; \texttt{<3x50,\discretionary{}{}{}0>}~\textit{(tied at TIME\_LIMIT)} \\
\hline
\rowcolor{blue!12}   2 & zono        & prev\_pgd & 0.5+sg & \textbf{1.308} &   271 &    507 & \textbf{53.45\%} & \texttt{<cnn1,\discretionary{}{}{}translation,\discretionary{}{}{}3,\discretionary{}{}{}3>} & \texttt{<{3x50,\discretionary{}{}{}cnn1},\discretionary{}{}{}2>}\textsuperscript{*}~\textit{(tied at TIME\_LIMIT)}; \texttt{<3x50,\discretionary{}{}{}0>}~\textit{(tied at TIME\_LIMIT)} \\
\hline
\end{tabular}%
\end{adjustbox}
...
% auto-generated: 12 paired sp+win-rate rows across 3 archs, seed=None, tau=None, combo_filter=zono:prev_pgd:0.0+sg,zono:prev_pgd:0.5+sg
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{cnn1} \textbar{} pert \textbf{patch} (p\_sizes merged: \texttt{1,14,14,3}) \textbar{} 2 combos, total $n=54$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,2.57\,(1/1) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.89\,(1/1)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  ...
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.894);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.894);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.944) {1.89};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,2.568);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.568);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,2.618) {2.57};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,3.62) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{cnn1} \textbar{} pert \textbf{patch} (p\_sizes merged: \texttt{1,14,14,3}) \textbar{} 2 combos, total $n=54$ cells, $n_{\max}=27$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,89\%\,(24f+0t/27) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,67\%\,(18f+0t/27)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  ...
  \fill[red!75!black] (1.02,0) rectangle (1.48,2.667);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.667);
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{cnn1} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=107$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,2.22\,(2/2) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,2.14\,(2/2)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,2.141);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.141);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.191) {2.14};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,2.220);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.220);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,2.270) {2.22};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,3.27) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{cnn1} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=107$ cells, $n_{\max}=54$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,65\%\,(35f+0t/54) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,64\%\,(34f+0t/53)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  ...
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.889);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.889);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.964) {64\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.944);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.944);
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{cnn1} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=85$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.65\,(3/3) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.41\,(3/3)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.651);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.651);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.701) {1.65};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.405);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.405);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.455) {1.41};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (0.55,2.70) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{cnn1} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=85$ cells, $n_{\max}=58$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,78\%\,(19f+2t/27) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,57\%\,(32f+1t/58)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=58$};
  \node[left, font=\tiny] at (0,0.75) {14};
  \node[left, font=\tiny] at (0,1.50) {29};
  \node[left, font=\tiny] at (0,2.25) {44};
  \node[left, font=\tiny] at (0,3.00) {58};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,1.397);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.397);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.983);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.983);
  \fill[white] (0.33,0.983) rectangle (0.78,1.086);
  \fill[blue!75!black, opacity=0.25] (0.33,0.983) rectangle (0.78,1.086);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.983) rectangle (0.78,1.086);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.983) rectangle (0.78,1.086);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.417) {78\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.655);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.655);
  \fill[white] (1.02,1.655) rectangle (1.48,1.707);
  \fill[red!75!black, opacity=0.25] (1.02,1.655) rectangle (1.48,1.707);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.655) rectangle (1.48,1.707);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.655) rectangle (1.48,1.707);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {57\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (0.55,2.45) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{cnn1} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=48$ cells.\\[0.4ex]
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{cnn1} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=48$ cells, $n_{\max}=24$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,92\%\,(0f+22t/24) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,67\%\,(0f+16t/24)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  ...
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[white] (1.02,0.000) rectangle (1.48,2.750);
  \fill[red!75!black, opacity=0.25] (1.02,0.000) rectangle (1.48,2.750);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.000) rectangle (1.48,2.750);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.000) rectangle (1.48,2.750);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {92\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,4.00) {$\bigstar$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{3x50} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=81$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.29\,(3/3) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.19\,(3/3)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.294);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.294);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.344) {1.29};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.188);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.188);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.238) {1.19};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (0.55,2.34) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{3x50} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=81$ cells, $n_{\max}=54$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,63\%\,(11f+6t/27) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,57\%\,(22f+9t/54)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=54$};
  ...
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,1.500);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.500);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.611);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.611);
  \fill[white] (0.33,0.611) rectangle (0.78,0.944);
  \fill[blue!75!black, opacity=0.25] (0.33,0.611) rectangle (0.78,0.944);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.611) rectangle (0.78,0.944);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.611) rectangle (0.78,0.944);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.520) {63\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  ...
  \fill[white] (1.02,1.222) rectangle (1.48,1.722);
  \fill[red!75!black, opacity=0.25] (1.02,1.222) rectangle (1.48,1.722);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.222) rectangle (1.48,1.722);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.222) rectangle (1.48,1.722);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {57\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (0.55,2.55) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{3x50} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=46$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.00\,(1/1) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.00\,(1/1)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{3x50} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=46$ cells, $n_{\max}=26$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,95\%\,(0f+19t/20) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,81\%\,(0f+21t/26)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  ...
  \fill[gray!30] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,3.000);
  \fill[white] (0.33,0.000) rectangle (0.78,2.423);
  \fill[blue!75!black, opacity=0.25] (0.33,0.000) rectangle (0.78,2.423);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.000) rectangle (0.78,2.423);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.000) rectangle (0.78,2.423);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,3.020) {81\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,2.308);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.308);
  \fill[white] (1.02,0.000) rectangle (1.48,2.192);
  \fill[red!75!black, opacity=0.25] (1.02,0.000) rectangle (1.48,2.192);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.000) rectangle (1.48,2.192);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.000) rectangle (1.48,2.192);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,2.328) {95\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,3.36) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{3x10} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=108$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.01\,(2/3) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,0.91\,(1/3)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.302);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.302);
  \fill[blue!75!black, opacity=0.25] (0.33,0.302) rectangle (0.78,0.906);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.302) rectangle (0.78,0.906);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.302) rectangle (0.78,0.906);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,0.956) {0.91};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,0.676);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,0.676);
  \fill[red!75!black, opacity=0.25] (1.02,0.676) rectangle (1.48,1.014);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.676) rectangle (1.48,1.014);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.676) rectangle (1.48,1.014);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.064) {1.01};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,2.06) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{3x10} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=108$ cells, $n_{\max}=81$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,35\%\,(28f+0t/81) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,22\%\,(6f+0t/27)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=81$};
  ...
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,1.000);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.000);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.222);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.222);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.020) {22\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.037);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.037);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {35\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,4.00) {$\bigstar$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{patch} (p\_sizes merged: \texttt{1,14,14,3}) \textbar{} 2 combos, total $n=162$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.56\,(1/1) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.31\,(1/1)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.310);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.310);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.360) {1.31};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.557);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.557);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.607) {1.56};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,2.61) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{patch} (p\_sizes merged: \texttt{1,14,14,3}) \textbar{} 2 combos, total $n=162$ cells, $n_{\max}=81$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,77\%\,(39f+23t/81) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,67\%\,(31f+23t/81)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=81$};
  ...
  \fill[gray!30] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,3.000);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.148);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.148);
  \fill[white] (0.33,1.148) rectangle (0.78,2.000);
  \fill[blue!75!black, opacity=0.25] (0.33,1.148) rectangle (0.78,2.000);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,1.148) rectangle (0.78,2.000);
  \draw[gray!50!black, line width=0.2pt] (0.33,1.148) rectangle (0.78,2.000);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,3.020) {67\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.444);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.444);
  \fill[white] (1.02,1.444) rectangle (1.48,2.296);
  \fill[red!75!black, opacity=0.25] (1.02,1.444) rectangle (1.48,2.296);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.444) rectangle (1.48,2.296);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.444) rectangle (1.48,2.296);
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=322$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.47\,(2/2) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.42\,(2/2)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.416);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.416);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.466) {1.42};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.474);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.474);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.524) {1.47};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,2.52) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{occ} (p\_sizes merged: \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=322$ cells, $n_{\max}=162$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,78\%\,(73f+53t/162) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,64\%\,(70f+33t/160)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=162$};
  \node[left, font=\tiny] at (0,0.75) {40};
  \node[left, font=\tiny] at (0,1.50) {81};
  \node[left, font=\tiny] at (0,2.25) {122};
  \node[left, font=\tiny] at (0,3.00) {162};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.963);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.963);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.296);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.296);
  \fill[white] (0.33,1.296) rectangle (0.78,1.907);
  \fill[blue!75!black, opacity=0.25] (0.33,1.296) rectangle (0.78,1.907);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,1.296) rectangle (0.78,1.907);
  \draw[gray!50!black, line width=0.2pt] (0.33,1.296) rectangle (0.78,1.907);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.983) {64\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.352);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.352);
  \fill[white] (1.02,1.352) rectangle (1.48,2.333);
  \fill[red!75!black, opacity=0.25] (1.02,1.352) rectangle (1.48,2.333);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.352) rectangle (1.48,2.333);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.352) rectangle (1.48,2.333);
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=274$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.28\,(2/3) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.18\,(0/3)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.856);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.856);
  \fill[blue!75!black, opacity=0.25] (0.33,0.856) rectangle (0.78,1.284);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.856) rectangle (0.78,1.284);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.856) rectangle (0.78,1.284);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.334) {1.28};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black, opacity=0.25] (1.02,0.000) rectangle (1.48,1.180);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.000) rectangle (1.48,1.180);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.000) rectangle (1.48,1.180);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.230) {1.18};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (0.55,2.33) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{translation} (p\_sizes merged: \texttt{1,1}, \texttt{3,1}, \texttt{3,3}) \textbar{} 2 combos, total $n=274$ cells, $n_{\max}=193$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,54\%\,(36f+8t/81) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,48\%\,(82f+10t/193)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=193$};
  \node[left, font=\tiny] at (0,0.75) {48};
  \node[left, font=\tiny] at (0,1.50) {96};
  \node[left, font=\tiny] at (0,2.25) {145};
  \node[left, font=\tiny] at (0,3.00) {193};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,1.259);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.259);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.560);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.560);
  \fill[white] (0.33,0.560) rectangle (0.78,0.684);
  \fill[blue!75!black, opacity=0.25] (0.33,0.560) rectangle (0.78,0.684);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.560) rectangle (0.78,0.684);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.560) rectangle (0.78,0.684);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.279) {54\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.275);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.275);
  \fill[white] (1.02,1.275) rectangle (1.48,1.430);
  \fill[red!75!black, opacity=0.25] (1.02,1.275) rectangle (1.48,1.430);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.275) rectangle (1.48,1.430);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.275) rectangle (1.48,1.430);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {48\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (0.55,2.31) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=148$ cells.\\[0.4ex]
...
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.024);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.024);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.074) {1.02};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=148$ cells, $n_{\max}=77$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,75\%\,(12f+41t/71) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,68\%\,(15f+37t/77)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=77$};
  \node[left, font=\tiny] at (0,0.75) {19};
  \node[left, font=\tiny] at (0,1.50) {38};
  \node[left, font=\tiny] at (0,2.25) {58};
  \node[left, font=\tiny] at (0,3.00) {77};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,3.000);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.584);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.584);
  \fill[white] (0.33,0.584) rectangle (0.78,2.026);
  \fill[blue!75!black, opacity=0.25] (0.33,0.584) rectangle (0.78,2.026);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.584) rectangle (0.78,2.026);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.584) rectangle (0.78,2.026);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,3.020) {68\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,2.766);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.766);
  \fill[red!75!black] (1.02,0) rectangle (1.48,0.468);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,0.468);
  \fill[white] (1.02,0.468) rectangle (1.48,2.065);
  \fill[red!75!black, opacity=0.25] (1.02,0.468) rectangle (1.48,2.065);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.468) rectangle (1.48,2.065);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.468) rectangle (1.48,2.065);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,2.786) {75\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,3.82) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{ALL} (p\_sizes merged: \texttt{0.1}, \texttt{1,1}, \texttt{1,14,14,3}, \texttt{3,1}, \texttt{3,3}, \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=906$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.31\,(4/7) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.29\,(6/7)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
  \draw[dashed, gray] (0,1) -- (1.85,1) node[right]{$=1$};
  ...
  \node[left, font=\tiny] at (0,2) {2};
  \node[left, font=\tiny] at (0,3) {3};
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.107);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.107);
  \fill[blue!75!black, opacity=0.25] (0.33,1.107) rectangle (0.78,1.292);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,1.107) rectangle (0.78,1.292);
  \draw[gray!50!black, line width=0.2pt] (0.33,1.107) rectangle (0.78,1.292);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,1.342) {1.29};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,0.748);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,0.748);
  \fill[red!75!black, opacity=0.25] (1.02,0.748) rectangle (1.48,1.308);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.748) rectangle (1.48,1.308);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.748) rectangle (1.48,1.308);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.358) {1.31};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,2.36) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
\hfill
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{ALL} (p\_sizes merged: \texttt{0.1}, \texttt{1,1}, \texttt{1,14,14,3}, \texttt{3,1}, \texttt{3,3}, \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=906$ cells, $n_{\max}=507$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,66\%\,(206f+127t/507) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,63\%\,(152f+101t/399)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=507$};
  \node[left, font=\tiny] at (0,0.75) {127};
  \node[left, font=\tiny] at (0,1.50) {254};
  \node[left, font=\tiny] at (0,2.25) {380};
  \node[left, font=\tiny] at (0,3.00) {507};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.361);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.361);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.899);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.899);
  \fill[white] (0.33,0.899) rectangle (0.78,1.497);
  \fill[blue!75!black, opacity=0.25] (0.33,0.899) rectangle (0.78,1.497);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.899) rectangle (0.78,1.497);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.899) rectangle (0.78,1.497);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.381) {63\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.219);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.219);
  \fill[white] (1.02,1.219) rectangle (1.48,1.970);
  \fill[red!75!black, opacity=0.25] (1.02,1.219) rectangle (1.48,1.970);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.219) rectangle (1.48,1.970);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.219) rectangle (1.48,1.970);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,3.020) {66\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,4.00) {$\bigstar$};
\end{tikzpicture}
\end{center}
...
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &   164 &   79.56 &   36.21 & \textbf{2.197} & \textit{ 527.32} & \textit{  95.15} & \textit{\textbf{5.542}} & \textit{0.53} \\
...
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     6 &   164 & 3619.17 &  153.59 & \textbf{23.564} &         &         &         &         \\
...
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.0+sg &     2 &     0 &     0 &   79.56 &   44.07 & \textbf{1.805} & \textit{ 527.32} & \textit{ 135.66} & \textit{\textbf{3.887}} & \textit{0.53} \\
...
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     6 &     0 & 3619.17 &  289.90 & \textbf{12.484} &         &         &         &         \\
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} occ         & \texttt{3,3,5}       & zono        & prev\_pgd & 0.5+sg &     0 &     1 &   166 &  261.44 &   67.56 & \textbf{3.870} & \textit{ 151.83} & \textit{ 136.22} & \textit{\textbf{1.115}} & \textit{0.04} \\
...
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 &  261.44 &  155.79 & \textbf{1.678} & \textit{ 151.83} & \textit{1274.66} & \textit{0.119} & \textit{0.24} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   79.60 &   59.14 & \textbf{1.346} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &  191.10 &  113.96 & \textbf{1.677} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &  367.16 & 10819.91 & 0.034 &         &         &         &         \\
...
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &   166 &  304.94 &   85.45 & \textbf{3.569} & \textit{ 116.59} & \textit{  62.82} & \textit{\textbf{1.856}} & \textit{0.03} \\
...
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &   166 &   88.87 &  108.84 & 0.817 &         &         &         &         \\
...
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.0+sg &     1 &     2 &     0 &   63.44 &   34.03 & \textbf{1.864} & \textit{  93.04} & \textit{  74.15} & \textit{\textbf{1.255}} & \textit{0.04} \\
...
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &     0 &   88.87 &   81.06 & \textbf{1.096} &         &         &         &         \\
...
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{cnn1} --- perturbation \textbf{occ}(\texttt{3,3,5}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (53 cell rows); continuation of Table~\ref{tab:safe_cnn1}. Column meanings: see Table~\ref{tab:safe_cnn1}.}
...
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &   173 &   59.49 &   42.21 & \textbf{1.409} & \textit{ 116.01} & \textit{1595.97} & \textit{0.073} & \textit{0.32} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &   173 &   58.98 &   57.44 & \textbf{1.027} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &   173 &   42.18 &   58.00 & 0.727 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &   173 &  536.01 & 10820.14 & 0.050 &         &         &         &         \\
...
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.0+sg &     2 &     0 &     0 &   43.91 &   25.70 & \textbf{1.709} & \textit{ 485.37} & \textit{ 152.15} & \textit{\textbf{3.190}} & \textit{0.35} \\
...
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     7 &     0 & 3618.31 &  291.69 & \textbf{12.405} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     8 &     0 &   40.99 &   33.72 & \textbf{1.216} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     9 &     0 &  205.61 &  527.98 & 0.389 &         &         &         &         \\
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &   173 &   43.91 &   59.53 & 0.738 & \textit{ 485.37} & \textit{ 154.45} & \textit{\textbf{3.143}} & \textit{0.35} \\
...
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     7 &   173 & 3618.31 &  372.63 & \textbf{9.710} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     8 &   173 &   40.99 &   74.80 & 0.548 &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     9 &   173 &  205.61 &  514.30 & 0.400 &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{cnn1} --- perturbation \textbf{occ}(\texttt{5,5,5}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (54 cell rows); continuation of Table~\ref{tab:safe_cnn1}. Column meanings: see Table~\ref{tab:safe_cnn1}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{1,1}         & zono        & prev\_pgd & 0.5+sg &     0 &     1 &   172 & 1009.61 &  463.99 & \textbf{2.176} & \textit{ 961.33} & \textit{ 852.94} & \textit{\textbf{1.127}} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &   172 &  857.36 &  297.15 & \textbf{2.885} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &   172 &  396.47 &  671.24 & 0.591 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &   172 &  427.21 &  494.53 & 0.864 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &   172 &  353.94 &  549.25 & 0.644 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &   172 &  396.65 &  581.62 & 0.682 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &   172 &  380.41 &  407.09 & 0.934 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &   172 & 1215.81 &  599.07 & \textbf{2.029} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &   172 & 3614.49 & 3612.48 & \textbf{1.001} &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 & 1009.61 &  687.11 & \textbf{1.469} & \textit{ 961.33} & \textit{ 895.86} & \textit{\textbf{1.073}} & \textit{0.02} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &  857.36 &  429.61 & \textbf{1.996} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &  396.47 &  281.24 & \textbf{1.410} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &  427.21 &  390.07 & \textbf{1.095} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &  353.94 &  602.62 & 0.587 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &  396.65 &  271.81 & \textbf{1.459} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &  380.41 &  495.97 & 0.767 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 & 1215.81 & 1291.95 & 0.941 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 & 3614.49 & 3612.36 & \textbf{1.001} &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &   172 & 3619.17 & 1570.96 & \textbf{2.304} & \textit{1744.30} & \textit{1691.15} & \textit{\textbf{1.031}} & \textit{0.07} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &   172 & 3614.93 & 10821.20 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3615\,$s, $T_{\mathrm{adv}}=10821\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &   172 &  316.85 &  533.16 & 0.594 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &   172 & 1264.50 &  981.55 & \textbf{1.288} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &   172 &  488.99 &  280.15 & \textbf{1.745} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &   172 &  322.07 &  489.08 & 0.659 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &   172 &  700.92 &  475.60 & \textbf{1.474} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &   172 & 3620.86 & 5094.39 & 0.711 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &   172 & 3621.04 & 4104.30 & 0.882 &         &         &         &         \\
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &   172 & 1096.65 &  916.79 & \textbf{1.196} & \textit{1290.12} & \textit{1050.74} & \textit{\textbf{1.228}} & \textit{0.03} \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     1 &   172 & 1835.23 & 1365.36 & \textbf{1.344} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     3 &   172 & 1214.52 & 1929.27 & 0.630 &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     4 &   172 & 2218.20 &  908.98 & \textbf{2.440} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     5 &   172 &  915.50 &  506.35 & \textbf{1.808} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     6 &   172 & 1149.06 &  864.19 & \textbf{1.330} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     7 &   172 &  930.42 &  820.75 & \textbf{1.134} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     8 &   172 &  961.39 & 1094.25 & 0.879 &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     9 &   172 & 3621.99 & 10825.22 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3622\,$s, $T_{\mathrm{adv}}=10825\,$s)} \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{cnn1} --- perturbation \textbf{translation}(\texttt{1,1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (36 cell rows); continuation of Table~\ref{tab:safe_cnn1}. Column meanings: see Table~\ref{tab:safe_cnn1}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{3,1}         & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 &  993.01 &  480.37 & \textbf{2.067} & \textit{1027.46} & \textit{ 835.91} & \textit{\textbf{1.229}} & \textit{0.02} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 & 1145.05 &  224.68 & \textbf{5.096} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &  578.23 &  550.85 & \textbf{1.050} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &  553.01 &  619.57 & 0.893 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &  547.85 &  475.93 & \textbf{1.151} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &  553.28 &  421.37 & \textbf{1.313} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &  628.08 &  337.92 & \textbf{1.859} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &  622.25 &  793.25 & 0.784 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 & 3626.42 & 3619.25 & \textbf{1.002} &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &   190 &  993.01 &  278.08 & \textbf{3.571} & \textit{1027.46} & \textit{ 905.59} & \textit{\textbf{1.135}} & \textit{0.03} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &   190 & 1145.05 &  245.49 & \textbf{4.664} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &   190 &  578.23 &  825.95 & 0.700 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &   190 &  553.01 &  547.85 & \textbf{1.009} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &   190 &  547.85 &  561.06 & 0.976 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &   190 &  553.28 &  737.07 & 0.751 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &   190 &  628.08 &  687.81 & 0.913 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &   190 &  622.25 & 1065.84 & 0.584 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &   190 & 3626.42 & 3201.13 & \textbf{1.133} &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &   190 &  488.43 &  681.02 & 0.717 & \textit{ 338.79} & \textit{ 389.39} & \textit{0.870} & \textit{0.04} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &   190 &  521.80 &  393.13 & \textbf{1.327} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &   190 &  263.14 &  283.29 & 0.929 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &   190 &  329.09 &  197.08 & \textbf{1.670} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &   190 &  161.75 &  255.53 & 0.633 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &   190 &   95.84 &  582.14 & 0.165 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &   190 &  223.78 &  281.22 & 0.796 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &   190 &  374.30 &  341.80 & \textbf{1.095} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &   190 &  590.99 &  489.33 & \textbf{1.208} &         &         &         &         \\
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &   190 &  720.97 & 1412.12 & 0.511 & \textit{1971.41} & \textit{1228.04} & \textit{\textbf{1.605}} & \textit{0.07} \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     1 &   190 & 1129.50 & 1129.08 & \textbf{1.000} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     3 &   190 & 2415.76 &  862.93 & \textbf{2.799} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     4 &   190 & 3619.39 & 1508.02 & \textbf{2.400} &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{cnn1} --- perturbation \textbf{translation}(\texttt{3,1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (31 cell rows); continuation of Table~\ref{tab:safe_cnn1}. Column meanings: see Table~\ref{tab:safe_cnn1}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{3,3}         & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 & 1338.15 &  213.25 & \textbf{6.275} & \textit{1469.32} & \textit{1060.53} & \textit{\textbf{1.385}} & \textit{0.02} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &  929.01 &  387.88 & \textbf{2.395} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &  726.30 &  357.77 & \textbf{2.030} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 & 3623.77 & 2743.37 & \textbf{1.321} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &  663.76 &  647.13 & \textbf{1.026} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &  951.77 &  566.89 & \textbf{1.679} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &  980.67 &  763.35 & \textbf{1.285} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &  408.27 &  252.37 & \textbf{1.618} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 & 3612.96 & 3612.75 & \textbf{1.000} &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &   190 & 1338.15 &  410.66 & \textbf{3.259} & \textit{1469.40} & \textit{1241.79} & \textit{\textbf{1.183}} & \textit{0.13} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &   190 &  929.01 &  411.27 & \textbf{2.259} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &   190 &  726.30 &  400.27 & \textbf{1.815} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &   190 & 3623.77 & 1650.16 & \textbf{2.196} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &   190 &  663.76 &  325.70 & \textbf{2.038} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &   190 &  951.77 &  390.67 & \textbf{2.436} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &   190 &  980.67 &  359.85 & \textbf{2.725} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &   190 &  408.27 & 10819.04 & 0.038 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &   190 & 3612.96 & 3613.75 & 1.000 &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &   190 & 3619.92 & 8929.92 & 0.405 & \textit{2005.84} & \textit{4590.35} & \textit{0.437} & \textit{0.36} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &   190 & 3620.52 & 10815.51 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3621\,$s, $T_{\mathrm{adv}}=10816\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &   190 & 3622.40 & 10823.80 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3622\,$s, $T_{\mathrm{adv}}=10824\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &   190 & 3624.72 & 10820.86 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3625\,$s, $T_{\mathrm{adv}}=10821\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &   190 & 3624.51 & 10821.23 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3625\,$s, $T_{\mathrm{adv}}=10821\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &   190 & 3623.87 & 10822.00 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3624\,$s, $T_{\mathrm{adv}}=10822\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &   190 &  391.76 &  250.77 & \textbf{1.562} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &   190 & 3622.88 & 10821.53 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3623\,$s, $T_{\mathrm{adv}}=10822\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &   190 & 3613.12 & 10814.54 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3613\,$s, $T_{\mathrm{adv}}=10815\,$s)} \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{cnn1} --- perturbation \textbf{translation}(\texttt{3,3}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (27 cell rows); continuation of Table~\ref{tab:safe_cnn1}. Column meanings: see Table~\ref{tab:safe_cnn1}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} linf        & \texttt{0.1}         & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 & 3620.83 & 3611.20 & \textbf{1.003} & \textit{3620.25} & \textit{3611.35} & \textit{\textbf{1.002}} & \textit{2.07} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 & 3623.78 & 3611.38 & \textbf{1.003} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 & 3619.84 & 3611.37 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 & 3622.05 & 3611.12 & \textbf{1.003} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 & 3624.49 & 3611.29 & \textbf{1.004} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 & 3616.40 & 10822.63 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3616\,$s, $T_{\mathrm{adv}}=10823\,$s)} \\
...
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &   164 & 3620.83 & 3612.45 & \textbf{1.002} & \textit{3619.82} & \textit{3612.33} & \textit{\textbf{1.002}} & \textit{1.74} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &   164 & 3623.78 & 3611.63 & \textbf{1.003} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &   164 & 3619.84 & 3611.85 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &   164 & 3622.05 & 3612.76 & \textbf{1.003} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &   164 & 3624.49 & 3611.88 & \textbf{1.003} &         &         &         &         \\
...
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &   164 & 3621.18 & 10820.50 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3621\,$s, $T_{\mathrm{adv}}=10820\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &   164 & 3618.57 & 3612.33 & \textbf{1.002} & \textit{3615.28} & \textit{3612.32} & \textit{\textbf{1.001}} & \textit{4.42} \\
...
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &   164 & 3614.64 & 10822.39 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3615\,$s, $T_{\mathrm{adv}}=10822\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &   164 & 3613.69 & 10823.69 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3614\,$s, $T_{\mathrm{adv}}=10824\,$s)} \\
...
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{cnn1} --- perturbation \textbf{linf}(\texttt{0.1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (52 cell rows); continuation of Table~\ref{tab:safe_cnn1}. Column meanings: see Table~\ref{tab:safe_cnn1}.}
...
\hline
\rowcolor{orange!20} translation & \texttt{1,1}         & zono        & prev\_pgd & 0.5+sg &     0 &         1 &                0 &   0.8088 &   0.8381 &   0.0293 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &         1 &                0 &   0.8088 &   0.9359 &   0.1270 \\
\hline
\rowcolor{orange!20} translation & \texttt{3,1}         & zono        & prev\_pgd & 0.0+sg &     0 &         1 &                1 &   0.7279 & \textbf{0.6648} &   0.0631 \\
\hline
\rowcolor{orange!20} translation & \texttt{3,3}         & zono        & prev\_pgd & 0.0+sg &     0 &         1 &                1 &   1.5909 & \textbf{1.4782} &   0.1127 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &         1 &                1 &   1.5909 & \textbf{1.3020} &   0.2889 \\
\hline
\rowcolor{orange!20} linf        & \texttt{0.1}         & zono        & prev\_pgd & 0.5+sg &     2 &         9 &                9 &  30.6444 & \textbf{27.8192} &   2.8252 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &         9 &                8 &  19.9249 & \textbf{16.8783} &   3.0466 \\
\hline
...
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &         6 &                5 &  36.5968 & \textbf{31.1124} &   5.4843 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &         8 &                3 &  19.2190 &  19.7759 &   0.5569 \\
\hline
\end{tabular}%
\end{adjustbox}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{1,1}         & zono        & prev\_pgd & 0.5+sg &     0 &     1 &    24 & 3615.89 & 3611.09 & \textbf{1.001} & \textit{3617.74} & \textit{3615.92} & \textit{\textbf{1.001}} & \textit{0.09} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &    24 & 3617.24 & 3615.38 & \textbf{1.001} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &    24 & 3619.85 & 3620.50 & 1.000 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &    24 & 3620.84 & 3622.72 & 0.999 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &    24 & 3620.30 & 3611.90 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &    24 & 3618.13 & 3611.33 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &    24 & 3615.22 & 3619.54 & 0.999 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &    24 & 3619.06 & 3618.98 & \textbf{1.000} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &    24 & 3613.09 & 3611.82 & \textbf{1.000} &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 & 3615.89 & 3617.06 & 1.000 & \textit{3617.74} & \textit{3615.95} & \textit{\textbf{1.000}} & \textit{0.04} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 & 3617.24 & 3624.49 & 0.998 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 & 3619.85 & 3622.52 & 0.999 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 & 3620.84 & 3611.58 & \textbf{1.003} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 & 3620.30 & 3614.39 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 & 3618.13 & 3611.10 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 & 3615.22 & 3616.44 & 1.000 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 & 3619.06 & 3613.15 & \textbf{1.002} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 & 3613.09 & 3612.78 & \textbf{1.000} &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &    24 & 2914.21 & 2605.87 & \textbf{1.118} & \textit{2561.82} & \textit{3714.39} & \textit{0.690} & \textit{0.02} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &    24 & 3620.30 & 6262.18 & 0.578 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &    24 & 3621.36 & 4713.03 & 0.768 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &    24 &  640.19 &  764.15 & 0.838 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &    24 & 3621.28 & 10619.43 & 0.341 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &    24 & 3621.99 & 3946.47 & 0.918 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &    24 & 1195.51 &  921.17 & \textbf{1.298} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &    24 & 2031.54 & 2614.01 & 0.777 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &    24 & 1790.03 &  983.18 & \textbf{1.821} &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{3x50} --- perturbation \textbf{translation}(\texttt{1,1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (27 cell rows); continuation of Table~\ref{tab:safe_3x50}. Column meanings: see Table~\ref{tab:safe_3x50}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{3,1}         & zono        & prev\_pgd & 0.5+sg &     0 &     1 &    23 & 3617.62 & 3617.77 & 1.000 & \textit{1199.23} & \textit{ 867.90} & \textit{\textbf{1.382}} & \textit{0.02} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &    23 & 1310.01 &  560.82 & \textbf{2.336} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &    23 & 1533.28 &  874.37 & \textbf{1.754} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &    23 &  636.00 &  314.21 & \textbf{2.024} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &    23 &  408.89 &  393.79 & \textbf{1.038} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &    23 &  337.58 &  373.74 & 0.903 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &    23 & 2066.31 &  849.44 & \textbf{2.433} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &    23 &  210.60 &  263.50 & 0.799 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &    23 &  672.76 &  563.49 & \textbf{1.194} &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 & 3617.62 & 3620.79 & 0.999 & \textit{1199.23} & \textit{1153.92} & \textit{\textbf{1.039}} & \textit{0.03} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 & 1310.01 & 1172.47 & \textbf{1.117} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 & 1533.28 & 1184.32 & \textbf{1.295} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &  636.00 &  684.48 & 0.929 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &  408.89 &  413.93 & 0.988 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &  337.58 &  107.51 & \textbf{3.140} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 & 2066.31 & 2353.66 & 0.878 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &  210.60 &  246.83 & 0.853 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &  672.76 &  601.33 & \textbf{1.119} &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &    23 &  773.84 &  619.77 & \textbf{1.249} & \textit{ 732.58} & \textit{ 627.20} & \textit{\textbf{1.168}} & \textit{0.01} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &    23 &  462.25 &  695.15 & 0.665 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &    23 &  570.39 &  633.36 & 0.901 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &    23 &  726.65 &  644.40 & \textbf{1.128} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &    23 &  601.10 &  569.17 & \textbf{1.056} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &    23 & 1747.11 &  822.60 & \textbf{2.124} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &    23 &  745.12 &  353.01 & \textbf{2.111} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &    23 &  429.29 &  662.98 & 0.648 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &    23 &  537.50 &  644.32 & 0.834 &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{3x50} --- perturbation \textbf{translation}(\texttt{3,1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (27 cell rows); continuation of Table~\ref{tab:safe_3x50}. Column meanings: see Table~\ref{tab:safe_3x50}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{3,3}         & zono        & prev\_pgd & 0.5+sg &     0 &     1 &    23 & 3617.27 & 1850.57 & \textbf{1.955} & \textit{ 933.83} & \textit{ 503.43} & \textit{\textbf{1.855}} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &    23 &  268.16 &  139.78 & \textbf{1.918} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &    23 & 3134.51 & 1644.43 & \textbf{1.906} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &    23 &  173.50 &  117.85 & \textbf{1.472} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &    23 &  232.94 &  235.75 & 0.988 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &    23 &  234.27 &   80.42 & \textbf{2.913} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &    23 &  365.61 &  324.19 & \textbf{1.128} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &    23 &  119.96 &   69.03 & \textbf{1.738} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &    23 &  258.22 &   68.82 & \textbf{3.752} &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 & 3617.27 & 3103.64 & \textbf{1.165} & \textit{ 933.83} & \textit{ 737.61} & \textit{\textbf{1.266}} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &  268.16 &   89.59 & \textbf{2.993} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 & 3134.51 & 2361.19 & \textbf{1.328} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &  173.50 &   66.32 & \textbf{2.616} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &  232.94 &  202.66 & \textbf{1.149} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &  234.27 &  196.17 & \textbf{1.194} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &  365.61 &  137.73 & \textbf{2.655} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &  119.96 &  195.29 & 0.614 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &  258.22 &  285.89 & 0.903 &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &    23 &  381.33 &  625.88 & 0.609 & \textit{ 863.28} & \textit{1684.67} & \textit{0.512} & \textit{0.02} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &    23 &  176.23 &  374.36 & 0.471 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &    23 &  285.36 &  810.41 & 0.352 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &    23 &  332.86 &  793.43 & 0.420 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &    23 & 3614.20 & 6053.52 & 0.597 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &    23 & 2164.47 & 5011.69 & 0.432 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &    23 &  301.75 &  339.64 & 0.888 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &    23 &  351.56 &  500.49 & 0.702 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &    23 &  161.79 &  652.64 & 0.248 &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{3x50} --- perturbation \textbf{translation}(\texttt{3,3}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (27 cell rows); continuation of Table~\ref{tab:safe_3x50}. Column meanings: see Table~\ref{tab:safe_3x50}.}
...
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &    21 & 3616.22 & 3621.67 & 0.998 & \textit{3614.69} & \textit{3618.49} & \textit{0.999} & \textit{0.71} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &    21 & 3616.40 & 10825.18 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3616\,$s, $T_{\mathrm{adv}}=10825\,$s)} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &    21 & 3613.34 & 10824.23 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3613\,$s, $T_{\mathrm{adv}}=10824\,$s)} \\
...
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &    21 & 3613.60 & 10824.27 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3614\,$s, $T_{\mathrm{adv}}=10824\,$s)} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &    21 & 3613.23 & 10821.78 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3613\,$s, $T_{\mathrm{adv}}=10822\,$s)} \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &    21 & 3615.27 & 3613.26 & \textbf{1.001} & \textit{3614.86} & \textit{3612.33} & \textit{\textbf{1.001}} & \textit{0.61} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &    21 & 3618.23 & 3613.85 & \textbf{1.001} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &    21 & 3613.90 & 10822.77 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3614\,$s, $T_{\mathrm{adv}}=10823\,$s)} \\
...
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &    21 & 3611.58 & 10822.38 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3612\,$s, $T_{\mathrm{adv}}=10822\,$s)} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &    21 & 3613.61 & 3611.91 & \textbf{1.000} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &    21 & 3613.16 & 10819.36 & \multicolumn{5}{l}{\itshape\bfseries timeouts differ; 2nd attempt required ($T_{\mathrm{std}}=3613\,$s, $T_{\mathrm{adv}}=10819\,$s)} \\
\hline
...
\hline
\rowcolor{orange!20} translation & \texttt{1,1}         & zono        & prev\_pgd & 0.5+sg &     0 &         9 &                8 &   1.2608 & \textbf{1.1025} &   0.1583 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &         9 &                5 &   1.2608 & \textbf{1.2438} &   0.0170 \\
\hline
\rowcolor{orange!20} translation & \texttt{3,1}         & zono        & prev\_pgd & 0.5+sg &     0 &         1 &                1 &   1.2085 & \textbf{1.0323} &   0.1762 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &         1 &                1 &   1.2085 & \textbf{0.7794} &   0.4290 \\
\hline
\rowcolor{orange!20} linf        & \texttt{0.1}         & zono        & prev\_pgd & 0.0+sg &     0 &         9 &                8 &   9.5874 & \textbf{8.5966} &   0.9907 \\
\hline
...
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &         6 &                6 &   3.7890 & \textbf{2.5606} &   1.2284 \\
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &         5 &                5 &   9.6884 & \textbf{8.2706} &   1.4178 \\
\hline
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{1,1}         & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 &   21.02 &   21.52 & 0.977 & \textit{  19.33} & \textit{  18.12} & \textit{\textbf{1.067}} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   20.77 &   12.65 & \textbf{1.642} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &   20.40 &   15.84 & \textbf{1.288} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &   21.71 &   14.74 & \textbf{1.473} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &   19.03 &   19.88 & 0.957 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &   18.13 &   22.39 & 0.810 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &   17.97 &   15.49 & \textbf{1.160} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &   18.79 &   18.45 & \textbf{1.018} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &   16.15 &   22.16 & 0.729 &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &     0 &   21.02 &   22.67 & 0.927 & \textit{  19.33} & \textit{  22.97} & \textit{0.842} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   20.77 &   23.26 & 0.893 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &   20.40 &   23.94 & 0.852 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &   21.71 &   23.05 & 0.942 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &   19.03 &   22.90 & 0.831 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &   18.13 &   21.34 & 0.850 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &   17.97 &   23.40 & 0.768 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &   18.79 &   22.98 & 0.818 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &   16.15 &   23.16 & 0.697 &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &     0 &   21.40 &   17.77 & \textbf{1.204} & \textit{  16.79} & \textit{  21.19} & \textit{0.792} & \textit{0.01} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &     0 &   15.23 &   17.15 & 0.888 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &     0 &   16.48 &   16.28 & \textbf{1.012} &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &     0 &   17.31 &   21.38 & 0.810 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &     0 &   15.86 &   24.41 & 0.650 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &     0 &   15.86 &   23.55 & 0.673 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &     0 &   16.72 &   24.31 & 0.688 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &     0 &   15.76 &   22.99 & 0.686 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &     0 &   16.48 &   22.86 & 0.721 &         &         &         &         \\
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &     0 &   15.46 &   13.60 & \textbf{1.137} & \textit{  18.70} & \textit{  12.72} & \textit{\textbf{1.471}} & \textit{0.06} \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     1 &     0 &   25.33 &   13.94 & \textbf{1.817} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     3 &     0 &   15.59 &   12.95 & \textbf{1.204} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     4 &     0 &   23.44 &   10.95 & \textbf{2.141} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     5 &     0 &   14.88 &   14.95 & 0.995 &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     6 &     0 &   15.70 &   13.80 & \textbf{1.138} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     7 &     0 &   16.38 &   11.58 & \textbf{1.415} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     8 &     0 &   20.19 &   11.12 & \textbf{1.816} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     9 &     0 &   21.37 &   11.55 & \textbf{1.850} &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{3x10} --- perturbation \textbf{translation}(\texttt{1,1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (36 cell rows); continuation of Table~\ref{tab:safe_3x10}. Column meanings: see Table~\ref{tab:safe_3x10}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{3,1}         & zono        & prev\_pgd & 0.5+sg &     0 &     1 &     0 &   19.91 &   25.40 & 0.784 & \textit{  19.51} & \textit{  23.03} & \textit{0.847} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   21.57 &   24.73 & 0.872 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &   20.78 &   21.95 & 0.947 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &   22.93 &   24.60 & 0.932 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &   18.95 &   22.61 & 0.838 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &   18.07 &   24.35 & 0.742 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &   18.91 &   19.22 & 0.984 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &   16.48 &   24.92 & 0.661 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &   17.95 &   19.51 & 0.920 &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 &   19.91 &   23.48 & 0.848 & \textit{  19.51} & \textit{  23.20} & \textit{0.841} & \textit{0.01} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   21.57 &   22.92 & 0.941 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &   20.78 &   24.53 & 0.847 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &   22.93 &   22.49 & \textbf{1.020} &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &   18.95 &   23.45 & 0.808 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &   18.07 &   22.90 & 0.789 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &   18.91 &   23.84 & 0.793 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &   16.48 &   23.48 & 0.702 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &   17.95 &   21.70 & 0.827 &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &     0 &   16.07 &   23.49 & 0.684 & \textit{  17.92} & \textit{  22.96} & \textit{0.781} & \textit{0.04} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &     0 &   18.09 &   21.25 & 0.851 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &     0 &   16.42 &   22.67 & 0.724 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &     0 &   17.03 &   23.78 & 0.716 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &     0 &   19.38 &   21.60 & 0.897 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &     0 &   19.50 &   23.26 & 0.838 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &     0 &   16.99 &   23.14 & 0.734 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &     0 &   19.22 &   23.71 & 0.811 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &     0 &   18.62 &   23.77 & 0.783 &         &         &         &         \\
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &     0 &   15.54 &   10.34 & \textbf{1.503} & \textit{  17.41} & \textit{  11.76} & \textit{\textbf{1.480}} & \textit{0.07} \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     1 &     0 &   16.36 &   11.39 & \textbf{1.436} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     3 &     0 &   14.64 &   11.10 & \textbf{1.319} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     4 &     0 &   17.26 &   10.78 & \textbf{1.601} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     5 &     0 &   17.83 &   12.89 & \textbf{1.383} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     6 &     0 &   18.79 &   13.57 & \textbf{1.385} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     7 &     0 &   20.28 &   11.73 & \textbf{1.729} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     8 &     0 &   18.23 &   12.77 & \textbf{1.428} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     9 &     0 &   17.73 &   11.29 & \textbf{1.570} &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{3x10} --- perturbation \textbf{translation}(\texttt{3,1}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (36 cell rows); continuation of Table~\ref{tab:safe_3x10}. Column meanings: see Table~\ref{tab:safe_3x10}.}
...
p\_type & p\_size & \tech{bound\_tight} & \tech{varHint} & $\tau$ & c\_src & c\_tgt & n\_relax & t\_std & t\_adv & $\text{sp}$ & $\overline{t}^{\mathrm{std}}_{c\_\mathrm{src}}$ & $\overline{t}^{\mathrm{adv}}_{c\_\mathrm{src}}$ & $\overline{\text{sp}}_{c\_\mathrm{src}}$ & $\overline{|\delta_\mathrm{std}-\delta_\mathrm{adv}|}_{c\_\mathrm{src}}$ \\
\hline
\rowcolor{green!15} translation & \texttt{3,3}         & zono        & prev\_pgd & 0.0+sg &     0 &     1 &     0 &   20.81 &   21.11 & 0.986 & \textit{  16.73} & \textit{  22.37} & \textit{0.748} & \textit{0.02} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   14.98 &   22.80 & 0.657 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &   15.78 &   17.47 & 0.903 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &   16.31 &   24.73 & 0.660 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &   19.15 &   24.65 & 0.777 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &   17.06 &   20.25 & 0.842 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &   15.83 &   24.87 & 0.637 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &   14.54 &   25.41 & 0.572 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &   16.12 &   20.06 & 0.804 &         &         &         &         \\
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &     0 &   20.81 &   24.05 & 0.865 & \textit{  16.73} & \textit{  23.39} & \textit{0.715} & \textit{0.02} \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     2 &     0 &   14.98 &   23.41 & 0.640 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     3 &     0 &   15.78 &   23.89 & 0.661 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     4 &     0 &   16.31 &   24.09 & 0.677 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     5 &     0 &   19.15 &   22.60 & 0.847 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     6 &     0 &   17.06 &   23.98 & 0.711 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     7 &     0 &   15.83 &   24.09 & 0.657 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     8 &     0 &   14.54 &   21.29 & 0.683 &         &         &         &         \\
\rowcolor{green!15}             &                      &             &     &      &     0 &     9 &     0 &   16.12 &   23.12 & 0.697 &         &         &         &         \\
\hline
\rowcolor{yellow!25}             &                      & zono        & prev\_pgd & 0.5+sg &     1 &     0 &     0 &   14.18 &   22.03 & 0.644 & \textit{  14.45} & \textit{  22.40} & \textit{0.645} & \textit{0.02} \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     2 &     0 &   15.00 &   21.89 & 0.685 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     3 &     0 &   14.36 &   22.38 & 0.642 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     4 &     0 &   14.20 &   23.58 & 0.602 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     5 &     0 &   13.59 &   22.21 & 0.612 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     6 &     0 &   14.41 &   23.41 & 0.616 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     7 &     0 &   14.91 &   21.30 & 0.700 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     8 &     0 &   14.71 &   23.28 & 0.632 &         &         &         &         \\
\rowcolor{yellow!25}             &                      &             &     &      &     1 &     9 &     0 &   14.73 &   21.56 & 0.683 &         &         &         &         \\
\hline
\rowcolor{magenta!20}             &                      & zono        & prev\_pgd & 0.5+sg &     2 &     0 &     0 &   19.35 &   10.98 & \textbf{1.762} & \textit{  19.24} & \textit{  13.16} & \textit{\textbf{1.462}} & \textit{0.05} \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     1 &     0 &   17.88 &   16.03 & \textbf{1.115} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     3 &     0 &   18.68 &   15.87 & \textbf{1.177} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     4 &     0 &   19.41 &   13.04 & \textbf{1.488} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     5 &     0 &   20.22 &   14.14 & \textbf{1.430} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     6 &     0 &   18.31 &   12.27 & \textbf{1.492} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     7 &     0 &   18.48 &   10.91 & \textbf{1.694} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     8 &     0 &   21.35 &   12.56 & \textbf{1.700} &         &         &         &         \\
\rowcolor{magenta!20}             &                      &             &     &      &     2 &     9 &     0 &   19.44 &   12.61 & \textbf{1.542} &         &         &         &         \\
\hline
\end{tabular}%
\end{adjustbox}
\caption{Architecture \textbf{3x10} --- perturbation \textbf{translation}(\texttt{3,3}), 2 combos \texttt{zono:prev\_pgd:0.0+sg}, \texttt{zono:prev\_pgd:0.5+sg} (36 cell rows); continuation of Table~\ref{tab:safe_3x10}. Column meanings: see Table~\ref{tab:safe_3x10}.}
...
% auto-generated: archs=['cnn1', '3x50', '3x10'], total_cells=1841
\begin{table}[!htbp]
\centering
\small
...
8 & N1, zono, $\tau$=0.5, SibGate & \textbf{1.198} & 13 & 21 & \textbf{61.9\%} \\
9 & N1, no-zono, $\tau$=0.0, no-PI & 0.708 & 6 & 15 & 40.0\% \\
10 & N2, no-zono, $\tau$=0.0 & \textbf{1.222} & 107 & 144 & \textbf{74.3\%} \\
11 & N2, zono, $\tau$=0.5 & \textbf{1.221} & 105 & 144 & \textbf{72.9\%} \\
12 & N2, no-zono, $\tau$=0.5 & \textbf{1.209} & 91 & 144 & \textbf{63.2\%} \\
13 & N2, zono, $\tau$=0.0 & \textbf{1.186} & 91 & 144 & \textbf{63.2\%} \\
14 & N2, zono, $\tau$=0.0, SibGate & \textbf{1.267} & 92 & 146 & \textbf{63.0\%} \\
15 & N2, no-zono, $\tau$=0.5, SibGate & \textbf{1.211} & 89 & 144 & \textbf{61.8\%} \\
16 & N2, no-zono, $\tau$=0.0, SibGate & \textbf{1.190} & 86 & 144 & \textbf{59.7\%} \\
17 & N2, no-zono, $\tau$=0.0, no-PI & \textbf{1.052} & 140 & 269 & \textbf{52.0\%} \\
18 & N2, zono, $\tau$=0.5, SibGate & \textbf{1.012} & 165 & 400 & 41.2\% \\
\hline
\end{tabular}
...
% auto-generated: archs=['cnn1', '3x50', '3x10'], dataset=mnist, total_cell_rows=5575
\begin{table}[!htbp]
\centering
\scriptsize
\setlength{\tabcolsep}{3pt}
\begin{adjustbox}{max width=\textwidth,center}%
\begin{tabular}{@{}l l l | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r | r r r@{}}
\hline
\multirow{2}{*}{model} & \multirow{2}{*}{pert (size)} & \multirow{2}{*}{missing c\_targets} & \multicolumn{3}{c|}{\textsf{vaghar}} & \multicolumn{3}{c|}{\textsf{zono+tau=0.0}} & \multicolumn{3}{c|}{\textsf{sg+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+sg+tau=0.0}} & \multicolumn{3}{c|}{\textsf{pi}} & \multicolumn{3}{c|}{\textsf{pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{zono+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{sg+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{sg+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{zono+sg+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+sg+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{adv+zono+prev\_pgd+sg+tau=0.0}} & \multicolumn{3}{c}{\textsf{adv+zono+prev\_pgd+sg+tau=0.5}} \\
...
\hline
\textbf{cnn1/N1} & brightness (0.25) & (1,2,3,4,6,7,8,9) & \cellcolor{green!25}28.8 & \cellcolor{green!25}99.2 & \cellcolor{green!25}18.1$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$c_s$=0 & linf (0.1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 63.7 & 99.2 & 60.3 & 64.8 & 100.0 & 60.3 & 64.8 & 99.3 & 60.3 & 67.5 & 99.5 & 60.3 & 65.2 & 100.0 & 60.3 & 66.1 & 100.0 & 60.3 & 66.8 & 99.2 & 112.8 & \cellcolor{green!25}70.8 & \cellcolor{green!25}99.6 & \cellcolor{green!25}137.1 & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=53.84, $\delta_d$=29.5\% & occ (1,1,5) & (1,2,6,7,8,9) & 14.2 & 14.3 & 5.3$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}14.2 & \cellcolor{green!25}14.3 & \cellcolor{green!25}3.5$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
dataset: \texttt{mnist} & occ (3,3,5) & (1,2,6,7,8,9) & 21.8 & 21.9 & 9.4$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 22.9 & 22.9 & 2.5 & 23.2 & 23.3 & 2.0 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.3 & \cellcolor{green!25}1.8 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.3 & \cellcolor{green!25}1.8 & 23.2 & 23.3 & 2.1 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.3 & \cellcolor{green!25}1.8 & 23.2 & 23.3 & 2.0 & 23.2 & 23.3 & 2.0 & --- & --- & --- & --- & --- & --- \\
 & occ (5,5,5) & (1,2,3,5,6,7,8,9) & 15.7 & 15.9 & 20.6$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.1 & 18.2 & 5.3 & 18.3 & 18.3 & 6.6 & 18.3 & 18.3 & 5.5 & 18.3 & 18.3 & 5.3 & 18.3 & 18.3 & 5.4 & 18.3 & 18.3 & 5.0 & \cellcolor{green!25}18.3 & \cellcolor{green!25}18.3 & \cellcolor{green!25}4.7 & 18.3 & 18.3 & 5.5 & --- & --- & --- & --- & --- & --- \\
 & patch (1,14,14,3) &  & 22.1 & 22.3 & 26.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}23.2 & \cellcolor{green!25}26.0 & \cellcolor{green!25}6.7 & 22.1 & 25.8 & 8.3 & 22.1 & 25.8 & 8.3 & 22.1 & 25.8 & 8.3 & 22.1 & 25.8 & 8.2 & 22.1 & 25.8 & 8.2 & 21.7 & 27.1 & 25.6 & 21.4 & 26.3 & 23.5 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) &  & 98.4 & 99.4 & 21.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.4 & 99.4 & 16.0 & 98.4 & 99.4 & 16.0 & 98.4 & 99.4 & 15.7 & 98.4 & 99.4 & 15.8 & 98.4 & 99.4 & 18.0 & \cellcolor{green!25}98.4 & \cellcolor{green!25}99.4 & \cellcolor{green!25}13.6 & 98.2 & 99.3 & 33.6 & 98.0 & 99.1 & 54.5 & --- & --- & --- & --- & --- & --- \\
 & translation (1,3) & (1,2,4,6,7,8,9) & \cellcolor{green!25}99.0 & \cellcolor{green!25}99.7 & \cellcolor{green!25}4.6$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & 98.6 & 99.5 & 13.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.7 & 99.5 & 13.9 & \cellcolor{green!25}98.7 & \cellcolor{green!25}99.5 & \cellcolor{green!25}11.0 & 98.7 & 99.5 & 11.4 & 98.7 & 99.5 & 14.4 & 98.7 & 99.5 & 12.9 & 98.6 & 99.5 & 12.9 & 98.5 & 99.4 & 23.1 & 98.7 & 99.5 & 11.1 & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) & (1,2,4,6,7,8,9) & \cellcolor{green!25}98.7 & \cellcolor{green!25}99.6 & \cellcolor{green!25}7.2$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.1 & 99.2 & 18.2 & 98.1 & 99.2 & 17.8 & 98.1 & 99.3 & 19.1 & 98.1 & 99.3 & 18.3 & 98.1 & 99.2 & 15.7 & 98.1 & 99.3 & 19.0 & 97.9 & 99.1 & 34.8 & 97.6 & 98.9 & 48.4 & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{cnn1/N1} & linf (0.1) & (5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}56.0 & \cellcolor{green!25}99.4 & \cellcolor{green!25}180.4$^*$ & --- & --- & --- & --- & --- & --- \\
$c_s$=1 & occ (1,1,5) & (0,2,5,6,7,8,9) & 8.7 & 8.8 & 5.5$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}8.9 & \cellcolor{green!25}9.0 & \cellcolor{green!25}0.8$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=75.87, $\delta_d$=13.6\% & occ (3,3,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}18.7 & \cellcolor{green!25}18.7 & \cellcolor{green!25}3.8 & --- & --- & --- & --- & --- & --- \\
dataset: \texttt{mnist} & occ (5,5,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}18.7 & \cellcolor{green!25}18.8 & \cellcolor{green!25}2.0 & --- & --- & --- & --- & --- & --- \\
 & patch (1,14,14,3) & (0,2,6,7,8,9) & 12.1 & 28.7 & 84.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}13.6 & \cellcolor{green!25}13.6 & \cellcolor{green!25}1.2$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 12.4 & 12.8 & 19.5 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) &  & \cellcolor{green!25}98.1 & \cellcolor{green!25}99.1 & \cellcolor{green!25}40.0 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.9 & 98.8 & 67.4 & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & \cellcolor{green!25}98.7 & \cellcolor{green!25}99.4 & \cellcolor{green!25}6.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.6 & 99.5 & 6.6 & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) & (8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.6 & \cellcolor{green!25}98.1 & \cellcolor{green!25}149.1$^*$ & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{cnn1/N1} & patch (1,14,14,3) &  & 12.9 & 16.8 & 56.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}12.9 & \cellcolor{green!25}13.8 & \cellcolor{green!25}50.5 & --- & --- & --- & --- & --- & --- \\
$c_s$=2 & translation (1,1) &  & 98.4 & 99.5 & 43.8 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.4 & \cellcolor{green!25}99.4 & \cellcolor{green!25}34.3 & --- & --- & --- & --- & --- & --- \\
\shortstack[l]{$\delta_{\max}$=72.82, $\delta_d$=27.6\%\\dataset: \texttt{mnist}} & translation (3,1) & (9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.7 & \cellcolor{green!25}100.0 & \cellcolor{green!25}36.1$^*$ & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{cnn1/N2} & linf (0.1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 64.4 & 100.0 & 60.3 & 59.9 & 100.0 & 60.4 & 64.7 & 100.0 & 60.3 & 67.2 & 99.7 & 60.3 & 62.9 & 100.0 & 60.3 & 59.2 & 100.0 & 60.3 & 65.5 & 100.0 & 60.3 & 68.9 & 100.0 & 117.2 & 68.5 & 100.0 & 123.8 & \cellcolor{green!25}70.4 & \cellcolor{green!25}100.0 & \cellcolor{green!25}140.3 \\
$c_s$=0 & occ (1,1,5) & (1,2,3,5,6,7,8,9) & 12.9 & 13.0 & 7.8$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}14.3 & \cellcolor{green!25}14.3 & \cellcolor{green!25}2.5$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=54.62, $\delta_d$=30.6\% & occ (3,3,5) & (1,2,3,5,6,7,8,9) & 20.0 & 20.1 & 16.4$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 22.8 & 22.8 & 2.3 & \cellcolor{green!25}22.9 & \cellcolor{green!25}23.0 & \cellcolor{green!25}1.9 & \cellcolor{green!25}22.9 & \cellcolor{green!25}23.0 & \cellcolor{green!25}1.9 & 22.9 & 23.0 & 2.2 & 22.9 & 23.0 & 2.1 & 22.9 & 23.0 & 2.2 & 22.9 & 23.0 & 2.1 & 22.9 & 23.0 & 2.1 & 22.9 & 24.1 & 14.5 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.4 & \cellcolor{green!25}1.9 \\
dataset: \texttt{mnist} & occ (5,5,5) & (1,2,6,7,8,9) & 17.5 & 17.6 & 6.5$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.0 & 18.0 & 4.4 & 18.1 & 18.1 & 7.5 & 18.1 & 18.1 & 7.3 & 18.1 & 18.1 & 6.7 & 18.1 & 18.1 & 7.0 & 18.1 & 18.1 & 7.0 & 18.1 & 18.1 & 7.3 & 18.1 & 18.1 & 6.9 & \cellcolor{green!25}18.1 & \cellcolor{green!25}18.2 & \cellcolor{green!25}1.4 & 17.9 & 19.7 & 26.9 \\
 & patch (1,14,14,3) &  & 21.9 & 47.1 & 128.9 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 22.4 & 22.5 & 2.4 & 21.8 & 21.9 & 3.3 & 21.8 & 21.9 & 3.7 & 21.8 & 21.9 & 3.7 & 21.8 & 21.9 & 3.3 & 21.8 & 21.9 & 3.6 & 21.8 & 21.9 & 3.4 & 21.8 & 21.9 & 3.6 & 21.8 & 21.9 & 1.2 & \cellcolor{green!25}21.9 & \cellcolor{green!25}22.1 & \cellcolor{green!25}1.1 \\
 & translation (1,1) &  & 98.8 & 99.7 & 34.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.6 & \cellcolor{green!25}99.9 & \cellcolor{green!25}19.2 & 98.7 & 100.0 & 21.8 & 98.6 & 100.0 & 21.8 & 98.6 & 100.0 & 20.7 & 98.6 & 100.0 & 20.0 & 98.6 & 100.0 & 22.2 & 98.6 & 100.0 & 22.7 & 98.5 & 100.0 & 70.6 & 98.6 & 99.7 & 31.5 & 98.8 & 99.8 & 26.2 \\
 & translation (1,3) & (1,2,4,6,7,8,9) & \cellcolor{green!25}99.1 & \cellcolor{green!25}99.9 & \cellcolor{green!25}4.9$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & 98.8 & 99.6 & 13.8 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.8 & 99.6 & 16.0 & 98.8 & 99.6 & 14.7 & 98.8 & 99.6 & 14.7 & 98.8 & 99.6 & 13.4 & 98.8 & 99.6 & 13.4 & \cellcolor{green!25}98.8 & \cellcolor{green!25}99.6 & \cellcolor{green!25}11.7 & 98.8 & 100.0 & 22.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}99.6 & \cellcolor{green!25}11.7 & 98.9 & 99.9 & 20.0 & 99.3 & 100.0 & 15.1 \\
 & translation (3,3) & (1,2,4,6,7,8,9) & \cellcolor{green!25}98.6 & \cellcolor{green!25}99.5 & \cellcolor{green!25}9.3$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.2 & 99.8 & 21.8 & 98.2 & 100.0 & 18.6 & 98.2 & 100.0 & 19.6 & 98.2 & 100.0 & 20.7 & 98.2 & 100.0 & 19.2 & 98.2 & 99.4 & 20.0 & 98.2 & 100.0 & 18.0 & 97.8 & 100.0 & 48.9 & 98.1 & 99.2 & 31.6 & 98.4 & 100.0 & 69.8 \\
\hline
\textbf{cnn1/N2} & linf (0.1) & (5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 48.6 & 100.0 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 57.2 & 100.0 & 180.4$^*$ & 57.2 & 100.0 & 60.2 & \cellcolor{green!25}60.9 & \cellcolor{green!25}100.0 & \cellcolor{green!25}120.3 \\
$c_s$=1 & occ (1,1,5) & (0,2,4,6,7,8,9) & 7.4 & 40.7 & 1.9$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}9.0 & \cellcolor{green!25}9.1 & \cellcolor{green!25}1.4$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=75.25, $\delta_d$=13.3\% & occ (3,3,5) & (0) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.9 & 18.9 & 1.9 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.8 & 18.9 & 2.5 & 18.7 & 18.9 & 1.2$^*$ & \cellcolor{green!25}19.0 & \cellcolor{green!25}19.2 & \cellcolor{green!25}1.0 \\
dataset: \texttt{mnist} & occ (5,5,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 19.0 & 19.0 & 1.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 19.0 & 19.0 & 1.9 & 19.0 & 19.1 & 1.3 & \cellcolor{green!25}19.3 & \cellcolor{green!25}19.5 & \cellcolor{green!25}1.1 \\
 & patch (1,14,14,3) &  & 12.2 & 30.4 & 86.8 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 12.6 & 12.6 & 1.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 12.2 & 12.2 & 3.0 & 12.2 & 12.3 & 6.0 & \cellcolor{green!25}12.3 & \cellcolor{green!25}12.4 & \cellcolor{green!25}0.8 \\
 & translation (1,1) &  & 98.4 & 99.3 & 39.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.3 & \cellcolor{green!25}99.4 & \cellcolor{green!25}32.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.2 & 99.1 & 71.4 & --- & --- & --- & 98.5 & 99.6 & 58.6 \\
 & translation (3,1) &  & 99.0 & 99.8 & 6.1 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.9 & 99.8 & 5.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}99.0 & \cellcolor{green!25}99.8 & \cellcolor{green!25}5.5 & --- & --- & --- & 99.4 & 100.0 & 6.5 \\
 & translation (3,3) & (7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.4 & \cellcolor{green!25}98.8 & \cellcolor{green!25}54.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 96.4 & 98.0 & 169.7$^*$ & --- & --- & --- & 96.8 & 98.3 & 157.3 \\
\hline
\textbf{cnn1/N2} & linf (0.1) & (4,8) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 57.8 & 99.2 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 59.2 & 100.0 & 60.3$^*$ & \cellcolor{green!25}62.0 & \cellcolor{green!25}99.6 & \cellcolor{green!25}60.3 \\
$c_s$=2 & occ (3,3,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 17.1 & 18.9 & 12.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 17.1 & 18.3 & 9.2 & \cellcolor{green!25}17.3 & \cellcolor{green!25}17.4 & \cellcolor{green!25}2.2 \\
$\delta_{\max}$=73.97, $\delta_d$=27.4\% & occ (5,5,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 19.5 & 20.5 & 8.1 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}19.6 & \cellcolor{green!25}19.7 & \cellcolor{green!25}2.5 & 20.1 & 20.2 & 2.6 \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & 12.7 & 16.5 & 33.9 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 12.7 & 14.1 & 8.8 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 12.7 & 12.7 & 1.9 & 12.7 & 12.8 & 2.3 & \cellcolor{green!25}12.8 & \cellcolor{green!25}12.9 & \cellcolor{green!25}1.6 \\
 & translation (1,1) &  & 98.3 & 100.0 & 73.0 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.3 & \cellcolor{green!25}99.4 & \cellcolor{green!25}25.8 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.4 & 99.4 & 37.6 & --- & --- & --- & 98.7 & 99.8 & 35.6 \\
 & translation (3,1) & (5,6,7,8,9) & \cellcolor{green!25}98.6 & \cellcolor{green!25}99.5 & \cellcolor{green!25}12.1$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.5 & 99.5 & 26.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.4 & 99.5 & 30.2 & --- & --- & --- & 99.0 & 99.9 & 20.5$^*$ \\
 & translation (3,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.1 & \cellcolor{green!25}99.0 & \cellcolor{green!25}54.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
\hline
\end{tabular}
\end{adjustbox}
\caption{Architecture \textbf{cnn1} (dataset mnist) --- the \textsf{missing c\_targets} column lists any $c_\mathrm{tgt}$ value (every class index except $c_\mathrm{src}$) that \emph{some} combo with a partial result on this row didn't cover. Equivalently: the union of per-combo missing sets restricted to combos that actually ran something on this row. Combos that never ran on the row (all-\textsf{---}) contribute nothing here. An empty cell therefore means every combo that has data on the row covered every expected $c_\mathrm{tgt}$. Per-combo partial coverage is also marked with a \textsuperscript{*} after that combo's $t$ sub-cell: \texttt{t.t$^*$} means this particular combo has data on this row but was not exercised on every expected $c_\mathrm{tgt}$ (so its mean time / $\delta$ aggregates over fewer cells than its un-starred peers). Combos with no data on a row show plain \textsf{---} with no star. Per technique-combo, each cell is a 3-tuple $(\delta_l, \delta_u, t)$: $\delta_l = 100 \cdot \mathrm{lower\_bound}/\delta_{\max}$ and $\delta_u = 100 \cdot \mathrm{upper\_bound}/\delta_{\max}$ are the MIP-returned bounds rescaled into per-cent units of the $\delta_{\max}$ in the model column; $t$ is the wall-clock time (minutes), mean over $c_\mathrm{tgt}$ and Gurobi seed. Each model cell groups by ($c_\mathrm{src}$) and reports $\delta_{\max}$ for that source class, as computed by Phase~0.5 of the sweep (\texttt{run.jl --perturbation max --ctag $c_\mathrm{src}$} per network) and cached under \texttt{paper\_experiments/mnist/<arch>\_exp/delta\_max/}. $\delta_{\max}$ is the sound upper bound on $\max_x N(x)[c_s] - \max_{k \ne c_s} N(x)[k]$ over the clean input box; rows where the pre-phase finished optimally show a bare value, rows where it hit \texttt{TIME\_LIMIT} show $\delta_{\max} \le Y$ (Gurobi upper bound). The two baselines \textsf{vaghar} (PI=off, no boosts) and \textsf{pi} (PI=on, no boosts) each pool together the standalone vaghar baseline runs (\texttt{vagharNoPerturbed\_*} / \texttt{vagharWithPerturbed\_*}) \emph{and} the \texttt{stdBoost} cells with all options off (zono=off, sg=off, tau=0 and matching pi value), since those cells encode an identical MIP and only differ in Gurobi seed. The remaining columns are the actual boosts. In the column labels, \textsf{zono} stands for \tech{nn1\_zono\_bounds}, \textsf{sg} for \tech{nn1\_sibling\_gate}, \textsf{pi} for \cli{use\_perturbed\_intervals}, and \textsf{tau=$x$} is \tech{nn1\_relax\_threshold}. Combinations the sweep filter excludes ((pi=off, tau$>0$); see \texttt{run\_relaxation\_sweep.py:2854}) appear as \textsf{---}. The two rightmost columns \textsf{adv+zono+prev\_pgd+sg+tau=0.0} and \textsf{adv+zono+prev\_pgd+sg+tau=0.5} report the advstd N2 transfer-mode runs for the two \texttt{zono:prev\_pgd:0.0+sg} and \texttt{zono:prev\_pgd:0.5+sg} combinations (loaded directly from the per-cell advstd CSVs that back Section~\ref{sec:safe}); these rows only populate on the $N_2$ block since advstd is a transfer technique. In each row, every winning combo's three sub-cells are shaded \cellcolor{green!25}~light~green: a combo wins if its mean $t$ ties the row-minimum (at the displayed 0.1-min precision) \emph{and} its underlying cells did \emph{not} all hit \texttt{TIME\_LIMIT}; if every combo on the row is timed out, winners are instead all combos sharing the smallest $\delta_u - \delta_l$ gap.}
...
\multirow{2}{*}{model} & \multirow{2}{*}{pert (size)} & \multirow{2}{*}{missing c\_targets} & \multicolumn{3}{c|}{\textsf{vaghar}} & \multicolumn{3}{c|}{\textsf{zono+tau=0.0}} & \multicolumn{3}{c|}{\textsf{sg+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+sg+tau=0.0}} & \multicolumn{3}{c|}{\textsf{pi}} & \multicolumn{3}{c|}{\textsf{pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{zono+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{sg+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{sg+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{zono+sg+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+sg+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{adv+zono+prev\_pgd+sg+tau=0.0}} & \multicolumn{3}{c}{\textsf{adv+zono+prev\_pgd+sg+tau=0.5}} \\
 &  &  & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ \\
\hline
\textbf{3x50/N1} & linf (0.1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}53.6 & \cellcolor{green!25}95.1 & \cellcolor{green!25}180.4 & --- & --- & --- & --- & --- & --- \\
$c_s$=0 & occ (3,3,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}0.7 & \cellcolor{green!25}1.5 & \cellcolor{green!25}180.3 & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=19.88, $\delta_d$=84.1\% & occ (5,5,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}7.4 & \cellcolor{green!25}11.9 & \cellcolor{green!25}180.4 & --- & --- & --- & --- & --- & --- \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 57.2 & 76.0 & 60.4 & 57.7 & 74.4 & 60.3 & 57.8 & 75.7 & 60.3 & 57.8 & 76.4 & 60.3 & 57.6 & 76.3 & 60.3 & 57.4 & 76.7 & 60.3 & \cellcolor{green!25}57.2 & \cellcolor{green!25}72.8 & \cellcolor{green!25}104.5 & 57.9 & 71.4 & 128.7 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 86.1 & 94.7 & 60.3 & 87.5 & 94.4 & 60.3 & 86.9 & 94.6 & 60.3 & 87.3 & 94.4 & 60.3 & 86.2 & 94.9 & 60.4 & 86.8 & 94.5 & 60.3 & 86.8 & 93.7 & 97.3 & \cellcolor{green!25}86.8 & \cellcolor{green!25}93.2 & \cellcolor{green!25}128.9 & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) & (4,5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.1 & \cellcolor{green!25}98.4 & \cellcolor{green!25}19.1 & 95.6 & 97.9 & 50.4$^*$ & 97.1 & 98.4 & 23.2 & 97.1 & 98.4 & 19.7 & 97.0 & 98.4 & 29.4$^*$ & 97.1 & 98.5 & 26.4$^*$ & 96.7 & 98.1 & 44.3 & 96.4 & 98.0 & 53.4 & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}99.0 & \cellcolor{green!25}99.8 & \cellcolor{green!25}12.0 & 98.9 & 99.8 & 13.5 & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{3x50/N1} & patch (1,14,14,3) & (5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}62.8 & \cellcolor{green!25}76.8 & \cellcolor{green!25}143.5$^*$ & --- & --- & --- & --- & --- & --- \\
\shortstack[l]{$c_s$=1\\$\delta_{\max}$=13.37, $\delta_d$=80.9\%\\dataset: \texttt{mnist}} & translation (1,1) & (4,5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}94.6 & \cellcolor{green!25}95.9 & \cellcolor{green!25}133.4$^*$ & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{3x50/N2} & linf (0.1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 48.5 & 96.6 & 60.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}54.5 & \cellcolor{green!25}94.0 & \cellcolor{green!25}180.4 & 52.8 & 94.7 & 116.8 & 54.2 & 94.3 & 140.4 \\
$c_s$=0 & occ (3,3,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 0.6 & 1.6 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 0.7 & 1.5 & 180.3 & 0.7 & 1.5 & 98.7 & \cellcolor{green!25}0.9 & \cellcolor{green!25}1.4 & \cellcolor{green!25}122.0 \\
$\delta_{\max}$=19.94, $\delta_d$=83.2\% & occ (5,5,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 6.3 & 13.2 & 60.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 7.5 & 12.1 & 180.3 & 6.7 & 12.6 & 101.9 & \cellcolor{green!25}7.7 & \cellcolor{green!25}12.2 & \cellcolor{green!25}120.3 \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 57.1 & 76.0 & 60.3 & 57.3 & 75.7 & 60.3 & 57.1 & 75.9 & 60.3 & 56.9 & 76.2 & 60.3 & 57.3 & 75.8 & 60.4 & 57.0 & 75.6 & 60.4 & 57.2 & 75.3 & 60.4 & 57.4 & 72.8 & 114.4 & \cellcolor{green!25}57.7 & \cellcolor{green!25}73.1 & \cellcolor{green!25}91.2 & 57.2 & 73.0 & 113.6 \\
 & translation (1,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 86.4 & 93.2 & 60.3 & 85.2 & 94.2 & 60.2 & 86.3 & 93.8 & 60.2 & 86.5 & 93.7 & 60.2 & 84.4 & 94.4 & 60.3 & 85.5 & 94.1 & 60.3 & 85.8 & 93.9 & 60.3 & 86.3 & 92.9 & 120.3 & 86.9 & 92.3 & 120.3 & \cellcolor{green!25}86.8 & \cellcolor{green!25}91.6 & \cellcolor{green!25}136.6 \\
 & translation (3,1) & (3,4,5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.2 & \cellcolor{green!25}97.6 & \cellcolor{green!25}20.0 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 93.3 & 96.7 & 41.5$^*$ & 96.4 & 97.6 & 37.1 & 95.9 & 97.4 & 35.3 & 95.5 & 97.0 & 44.6 \\
 & translation (3,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.0 & 98.9 & 15.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.0 & 98.9 & 16.8 & 98.0 & 98.9 & 12.3 & \cellcolor{green!25}98.1 & \cellcolor{green!25}99.0 & \cellcolor{green!25}8.4 \\
\hline
\textbf{3x50/N2} & linf (0.1) & (5) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 67.3 & 98.2 & 60.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 70.5 & 100.0 & 60.4$^*$ & \cellcolor{green!25}73.4 & \cellcolor{green!25}96.6 & \cellcolor{green!25}120.3 \\
$c_s$=1 & occ (3,3,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 0.9 & 2.3 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 0.9 & 2.3 & 60.2 & \cellcolor{green!25}1.7 & \cellcolor{green!25}2.3 & \cellcolor{green!25}120.3 \\
$\delta_{\max}$=12.95, $\delta_d$=80.6\% & occ (5,5,5) & (7) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 11.4 & 22.4 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 12.8 & 21.6 & 60.2$^*$ & \cellcolor{green!25}14.7 & \cellcolor{green!25}20.6 & \cellcolor{green!25}120.3 \\
dataset: \texttt{mnist} & patch (1,14,14,3) & (4,5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 61.2 & 82.5 & 58.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 66.2 & 79.8 & 129.3$^*$ & \cellcolor{green!25}61.3 & \cellcolor{green!25}79.6 & \cellcolor{green!25}56.2 & 60.7 & 76.1 & 113.9 \\
 & translation (1,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}95.7 & \cellcolor{green!25}97.0 & \cellcolor{green!25}42.7 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 95.9 & 96.8 & 61.9 \\
 & translation (3,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.3 & 99.0 & 12.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.6 & \cellcolor{green!25}99.5 & \cellcolor{green!25}10.5 \\
 & translation (3,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.2 & \cellcolor{green!25}98.9 & \cellcolor{green!25}14.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.5 & 99.4 & 28.1 \\
\hline
...
dataset: \texttt{mnist} & patch (1,14,14,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 44.0 & 74.5 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 44.9 & 72.5 & 60.3 & \cellcolor{green!25}45.2 & \cellcolor{green!25}72.2 & \cellcolor{green!25}60.3 \\
 & translation (1,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}87.8 & \cellcolor{green!25}92.9 & \cellcolor{green!25}55.1 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.1 & \cellcolor{green!25}98.1 & \cellcolor{green!25}22.7 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.8 & \cellcolor{green!25}99.5 & \cellcolor{green!25}10.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
\hline
\end{tabular}
\end{adjustbox}
\caption{Architecture \textbf{3x50} (dataset mnist) --- the \textsf{missing c\_targets} column lists any $c_\mathrm{tgt}$ value (every class index except $c_\mathrm{src}$) that \emph{some} combo with a partial result on this row didn't cover. Equivalently: the union of per-combo missing sets restricted to combos that actually ran something on this row. Combos that never ran on the row (all-\textsf{---}) contribute nothing here. An empty cell therefore means every combo that has data on the row covered every expected $c_\mathrm{tgt}$. Per-combo partial coverage is also marked with a \textsuperscript{*} after that combo's $t$ sub-cell: \texttt{t.t$^*$} means this particular combo has data on this row but was not exercised on every expected $c_\mathrm{tgt}$ (so its mean time / $\delta$ aggregates over fewer cells than its un-starred peers). Combos with no data on a row show plain \textsf{---} with no star. Per technique-combo, each cell is a 3-tuple $(\delta_l, \delta_u, t)$: $\delta_l = 100 \cdot \mathrm{lower\_bound}/\delta_{\max}$ and $\delta_u = 100 \cdot \mathrm{upper\_bound}/\delta_{\max}$ are the MIP-returned bounds rescaled into per-cent units of the $\delta_{\max}$ in the model column; $t$ is the wall-clock time (minutes), mean over $c_\mathrm{tgt}$ and Gurobi seed. Each model cell groups by ($c_\mathrm{src}$) and reports $\delta_{\max}$ for that source class, as computed by Phase~0.5 of the sweep (\texttt{run.jl --perturbation max --ctag $c_\mathrm{src}$} per network) and cached under \texttt{paper\_experiments/mnist/<arch>\_exp/delta\_max/}. $\delta_{\max}$ is the sound upper bound on $\max_x N(x)[c_s] - \max_{k \ne c_s} N(x)[k]$ over the clean input box; rows where the pre-phase finished optimally show a bare value, rows where it hit \texttt{TIME\_LIMIT} show $\delta_{\max} \le Y$ (Gurobi upper bound). The two baselines \textsf{vaghar} (PI=off, no boosts) and \textsf{pi} (PI=on, no boosts) each pool together the standalone vaghar baseline runs (\texttt{vagharNoPerturbed\_*} / \texttt{vagharWithPerturbed\_*}) \emph{and} the \texttt{stdBoost} cells with all options off (zono=off, sg=off, tau=0 and matching pi value), since those cells encode an identical MIP and only differ in Gurobi seed. The remaining columns are the actual boosts. In the column labels, \textsf{zono} stands for \tech{nn1\_zono\_bounds}, \textsf{sg} for \tech{nn1\_sibling\_gate}, \textsf{pi} for \cli{use\_perturbed\_intervals}, and \textsf{tau=$x$} is \tech{nn1\_relax\_threshold}. Combinations the sweep filter excludes ((pi=off, tau$>0$); see \texttt{run\_relaxation\_sweep.py:2854}) appear as \textsf{---}. The two rightmost columns \textsf{adv+zono+prev\_pgd+sg+tau=0.0} and \textsf{adv+zono+prev\_pgd+sg+tau=0.5} report the advstd N2 transfer-mode runs for the two \texttt{zono:prev\_pgd:0.0+sg} and \texttt{zono:prev\_pgd:0.5+sg} combinations (loaded directly from the per-cell advstd CSVs that back Section~\ref{sec:safe}); these rows only populate on the $N_2$ block since advstd is a transfer technique. In each row, every winning combo's three sub-cells are shaded \cellcolor{green!25}~light~green: a combo wins if its mean $t$ ties the row-minimum (at the displayed 0.1-min precision) \emph{and} its underlying cells did \emph{not} all hit \texttt{TIME\_LIMIT}; if every combo on the row is timed out, winners are instead all combos sharing the smallest $\delta_u - \delta_l$ gap.}
...
\multirow{2}{*}{model} & \multirow{2}{*}{pert (size)} & \multirow{2}{*}{missing c\_targets} & \multicolumn{3}{c|}{\textsf{vaghar}} & \multicolumn{3}{c|}{\textsf{zono+tau=0.0}} & \multicolumn{3}{c|}{\textsf{sg+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+sg+tau=0.0}} & \multicolumn{3}{c|}{\textsf{pi}} & \multicolumn{3}{c|}{\textsf{pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{zono+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{sg+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{sg+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{zono+sg+pi+tau=0.0}} & \multicolumn{3}{c|}{\textsf{zono+sg+pi+tau=0.5}} & \multicolumn{3}{c|}{\textsf{adv+zono+prev\_pgd+sg+tau=0.0}} & \multicolumn{3}{c}{\textsf{adv+zono+prev\_pgd+sg+tau=0.5}} \\
 &  &  & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ & $\delta_l$\% & $\delta_u$\% & $t$ \\
\hline
\textbf{3x10/N1} & linf (0.1) &  & 70.7 & 71.0 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}70.7 & \cellcolor{green!25}70.9 & \cellcolor{green!25}0.2 & 70.7 & 70.9 & 0.3 & 70.7 & 70.9 & 0.3 & 70.7 & 70.9 & 0.3 & \cellcolor{green!25}70.7 & \cellcolor{green!25}70.9 & \cellcolor{green!25}0.2 & \cellcolor{green!25}70.7 & \cellcolor{green!25}70.9 & \cellcolor{green!25}0.2 & 70.7 & 71.0 & 0.3 & 70.7 & 70.9 & 0.3 & --- & --- & --- & --- & --- & --- \\
$c_s$=0 & occ (1,1,5) & (1,2,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}0.4 & \cellcolor{green!25}0.4 & \cellcolor{green!25}0.3$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=32.77, $\delta_d$=49.6\% & occ (3,3,5) &  & 6.2 & 6.2 & 0.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 6.0 & 6.1 & 0.3 & 6.2 & 6.2 & 0.3 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & 6.2 & 6.2 & 0.3 & 6.2 & 6.2 & 0.3 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & 6.2 & 6.2 & 0.3 & --- & --- & --- & --- & --- & --- \\
dataset: \texttt{mnist} & occ (5,5,5) &  & 11.0 & 11.1 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 10.9 & 10.9 & 0.3 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
 & patch (1,14,14,3) &  & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.4 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}25.1 & \cellcolor{green!25}25.1 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}25.3 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) &  & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & 96.4 & 96.9 & 0.4 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & 97.9 & 98.3 & 0.3 & 97.9 & 98.3 & 0.3 & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & \cellcolor{green!25}97.9 & \cellcolor{green!25}98.3 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) &  & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & 98.4 & 98.6 & 0.3 & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.6 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{3x10/N1} & linf (0.1) &  & \cellcolor{green!25}69.8 & \cellcolor{green!25}70.1 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 69.8 & 70.3 & 0.5 & --- & --- & --- & --- & --- & --- \\
$c_s$=1 & occ (3,3,5) &  & 20.7 & 20.8 & 0.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}20.7 & \cellcolor{green!25}20.8 & \cellcolor{green!25}0.4 & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=40.50, $\delta_d$=20.0\% & occ (5,5,5) &  & 29.5 & 29.7 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}29.5 & \cellcolor{green!25}29.6 & \cellcolor{green!25}0.4 & --- & --- & --- & --- & --- & --- \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & 21.1 & 21.2 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}21.1 & \cellcolor{green!25}21.1 & \cellcolor{green!25}0.4 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) &  & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.9 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 96.4 & 96.9 & 0.4 & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & \cellcolor{green!25}97.6 & \cellcolor{green!25}97.7 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.6 & 97.7 & 0.4 & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) &  & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.9 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.5 & 98.9 & 0.4 & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{3x10/N1} & linf (0.1) &  & \cellcolor{green!25}60.0 & \cellcolor{green!25}60.3 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}60.0 & \cellcolor{green!25}60.4 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- \\
$c_s$=2 & occ (3,3,5) &  & 10.8 & 10.9 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}10.8 & \cellcolor{green!25}10.8 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=53.46, $\delta_d$=33.5\% & occ (5,5,5) &  & 18.6 & 18.7 & 0.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}18.6 & \cellcolor{green!25}18.7 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & 12.8 & 12.9 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}12.8 & \cellcolor{green!25}12.9 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) &  & \cellcolor{green!25}93.8 & \cellcolor{green!25}94.0 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}93.8 & \cellcolor{green!25}94.0 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
 & translation (3,1) &  & \cellcolor{green!25}97.0 & \cellcolor{green!25}97.1 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.0 & \cellcolor{green!25}97.1 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
 & translation (3,3) &  & \cellcolor{green!25}97.2 & \cellcolor{green!25}97.3 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.2 & \cellcolor{green!25}97.3 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- \\
\hline
\textbf{3x10/N2} & brightness (0.25) & (1,2,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}24.6 & \cellcolor{green!25}24.7 & \cellcolor{green!25}0.4$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$c_s$=0 & linf (0.05) & (1,2,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}38.7 & \cellcolor{green!25}39.0 & \cellcolor{green!25}0.3$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
$\delta_{\max}$=32.81, $\delta_d$=49.8\% & linf (0.1) &  & 70.9 & 71.3 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 70.9 & 71.2 & 0.3 & \cellcolor{green!25}70.9 & \cellcolor{green!25}71.3 & \cellcolor{green!25}0.2 & 70.9 & 71.3 & 0.3 & 70.9 & 71.3 & 0.3 & 70.9 & 71.3 & 0.3 & \cellcolor{green!25}70.9 & \cellcolor{green!25}71.3 & \cellcolor{green!25}0.2 & 70.9 & 71.3 & 0.3 & 70.9 & 71.2 & 0.3 & 70.9 & 71.2 & 0.3 & 70.9 & 71.2 & 0.3 \\
dataset: \texttt{mnist} & occ (1,1,5) & (1,2,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}0.4 & \cellcolor{green!25}0.4 & \cellcolor{green!25}0.3$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- \\
 & occ (3,3,5) &  & 6.2 & 6.2 & 0.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 6.2 & 6.2 & 0.3 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & 6.2 & 6.2 & 0.3 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 & 6.2 & 6.2 & 0.3 & \cellcolor{green!25}6.2 & \cellcolor{green!25}6.2 & \cellcolor{green!25}0.2 \\
 & occ (5,5,5) &  & 11.0 & 11.0 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 11.0 & 11.0 & 0.3 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & 11.0 & 11.0 & 0.3 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 \\
 & patch (1,14,14,3) &  & 25.4 & 25.5 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}25.4 & \cellcolor{green!25}25.5 & \cellcolor{green!25}0.2 & 25.4 & 25.4 & 0.3 & 25.4 & 25.4 & 0.3 & 25.4 & 25.4 & 0.3 & 25.4 & 25.4 & 0.3 & 25.4 & 25.4 & 0.3 & 25.4 & 25.4 & 0.3 & 25.4 & 25.4 & 0.3 & 25.4 & 25.5 & 0.3 & 25.4 & 25.5 & 0.3 \\
 & translation (1,1) &  & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.8 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 96.4 & 96.8 & 0.3 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.8 & \cellcolor{green!25}0.2 & 96.4 & 96.8 & 0.3 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.8 & \cellcolor{green!25}0.2 & 96.4 & 96.8 & 0.4 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.8 & \cellcolor{green!25}0.2 & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.8 & \cellcolor{green!25}0.2 & 96.4 & 96.8 & 0.4 & 96.4 & 96.8 & 0.3 & 96.4 & 96.8 & 0.4 \\
 & translation (3,1) &  & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.0 & 98.2 & 0.3 & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & 98.0 & 98.2 & 0.3 & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.0 & \cellcolor{green!25}98.2 & \cellcolor{green!25}0.2 & 98.0 & 98.2 & 0.4 & 98.0 & 98.2 & 0.4 \\
 & translation (3,3) &  & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & 98.5 & 98.8 & 0.3 & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & 98.5 & 98.8 & 0.3 & \cellcolor{green!25}98.5 & \cellcolor{green!25}98.8 & \cellcolor{green!25}0.2 & 98.5 & 98.8 & 0.4 & 98.5 & 98.8 & 0.4 \\
\hline
\textbf{3x10/N2} & linf (0.1) &  & \cellcolor{green!25}69.1 & \cellcolor{green!25}69.5 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}69.1 & \cellcolor{green!25}69.4 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 69.1 & 69.6 & 0.5 & \cellcolor{green!25}69.1 & \cellcolor{green!25}69.6 & \cellcolor{green!25}0.3 & \cellcolor{green!25}69.1 & \cellcolor{green!25}69.6 & \cellcolor{green!25}0.3 \\
$c_s$=1 & occ (3,3,5) &  & 20.5 & 20.7 & 0.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 20.5 & 20.5 & 0.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 20.5 & 20.6 & 0.4 & \cellcolor{green!25}20.5 & \cellcolor{green!25}20.6 & \cellcolor{green!25}0.2 & \cellcolor{green!25}20.5 & \cellcolor{green!25}20.6 & \cellcolor{green!25}0.2 \\
$\delta_{\max}$=41.06, $\delta_d$=20.0\% & occ (5,5,5) &  & 29.2 & 29.4 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 29.2 & 29.3 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 29.2 & 29.3 & 0.4 & 29.2 & 29.3 & 0.3 & \cellcolor{green!25}29.2 & \cellcolor{green!25}29.3 & \cellcolor{green!25}0.2 \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & 21.0 & 21.1 & 0.6 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 21.0 & 21.0 & 0.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 21.0 & 21.0 & 0.4 & \cellcolor{green!25}21.0 & \cellcolor{green!25}21.1 & \cellcolor{green!25}0.3 & \cellcolor{green!25}21.0 & \cellcolor{green!25}21.1 & \cellcolor{green!25}0.3 \\
 & translation (1,1) &  & \cellcolor{green!25}96.4 & \cellcolor{green!25}96.6 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 96.4 & 96.6 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 96.4 & 96.6 & 0.4 & --- & --- & --- & 96.5 & 96.6 & 0.4 \\
 & translation (3,1) &  & \cellcolor{green!25}97.5 & \cellcolor{green!25}97.6 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.5 & 97.6 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.5 & 97.6 & 0.4 & --- & --- & --- & 97.5 & 97.6 & 0.4 \\
 & translation (3,3) &  & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.4 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}98.4 & \cellcolor{green!25}98.5 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.4 & 98.4 & 0.4 & --- & --- & --- & 98.4 & 98.4 & 0.4 \\
\hline
\textbf{3x10/N2} & linf (0.1) &  & \cellcolor{green!25}60.8 & \cellcolor{green!25}61.1 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}60.8 & \cellcolor{green!25}61.1 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}60.8 & \cellcolor{green!25}61.2 & \cellcolor{green!25}0.3 & \cellcolor{green!25}60.8 & \cellcolor{green!25}61.0 & \cellcolor{green!25}0.3 & \cellcolor{green!25}60.8 & \cellcolor{green!25}61.0 & \cellcolor{green!25}0.3 \\
$c_s$=2 & occ (3,3,5) &  & 11.0 & 11.1 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 11.0 & 11.0 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.0 & \cellcolor{green!25}0.2 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.1 & \cellcolor{green!25}0.2 & \cellcolor{green!25}11.0 & \cellcolor{green!25}11.1 & \cellcolor{green!25}0.2 \\
$\delta_{\max}$=52.49, $\delta_d$=33.4\% & occ (5,5,5) &  & 18.9 & 19.1 & 0.4 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.9 & 19.0 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}18.9 & \cellcolor{green!25}19.0 & \cellcolor{green!25}0.2 & 18.9 & 19.0 & 0.3 & 18.9 & 19.0 & 0.3 \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & 13.1 & 13.2 & 0.5 & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}13.1 & \cellcolor{green!25}13.2 & \cellcolor{green!25}0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}13.1 & \cellcolor{green!25}13.2 & \cellcolor{green!25}0.3 & \cellcolor{green!25}13.1 & \cellcolor{green!25}13.2 & \cellcolor{green!25}0.3 & \cellcolor{green!25}13.1 & \cellcolor{green!25}13.2 & \cellcolor{green!25}0.3 \\
 & translation (1,1) &  & \cellcolor{green!25}93.9 & \cellcolor{green!25}94.0 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 93.9 & 94.2 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}93.9 & \cellcolor{green!25}94.0 & \cellcolor{green!25}0.2 & --- & --- & --- & \cellcolor{green!25}93.9 & \cellcolor{green!25}94.0 & \cellcolor{green!25}0.2 \\
 & translation (3,1) &  & \cellcolor{green!25}97.0 & \cellcolor{green!25}97.2 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.0 & 97.2 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.0 & \cellcolor{green!25}97.2 & \cellcolor{green!25}0.2 & --- & --- & --- & \cellcolor{green!25}97.0 & \cellcolor{green!25}97.2 & \cellcolor{green!25}0.2 \\
 & translation (3,3) &  & \cellcolor{green!25}97.3 & \cellcolor{green!25}97.6 & \cellcolor{green!25}0.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & 97.3 & 97.6 & 0.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}97.3 & \cellcolor{green!25}97.6 & \cellcolor{green!25}0.2 & --- & --- & --- & \cellcolor{green!25}97.3 & \cellcolor{green!25}97.6 & \cellcolor{green!25}0.2 \\
\hline
\end{tabular}
\end{adjustbox}
\caption{Architecture \textbf{3x10} (dataset mnist) --- the \textsf{missing c\_targets} column lists any $c_\mathrm{tgt}$ value (every class index except $c_\mathrm{src}$) that \emph{some} combo with a partial result on this row didn't cover. Equivalently: the union of per-combo missing sets restricted to combos that actually ran something on this row. Combos that never ran on the row (all-\textsf{---}) contribute nothing here. An empty cell therefore means every combo that has data on the row covered every expected $c_\mathrm{tgt}$. Per-combo partial coverage is also marked with a \textsuperscript{*} after that combo's $t$ sub-cell: \texttt{t.t$^*$} means this particular combo has data on this row but was not exercised on every expected $c_\mathrm{tgt}$ (so its mean time / $\delta$ aggregates over fewer cells than its un-starred peers). Combos with no data on a row show plain \textsf{---} with no star. Per technique-combo, each cell is a 3-tuple $(\delta_l, \delta_u, t)$: $\delta_l = 100 \cdot \mathrm{lower\_bound}/\delta_{\max}$ and $\delta_u = 100 \cdot \mathrm{upper\_bound}/\delta_{\max}$ are the MIP-returned bounds rescaled into per-cent units of the $\delta_{\max}$ in the model column; $t$ is the wall-clock time (minutes), mean over $c_\mathrm{tgt}$ and Gurobi seed. Each model cell groups by ($c_\mathrm{src}$) and reports $\delta_{\max}$ for that source class, as computed by Phase~0.5 of the sweep (\texttt{run.jl --perturbation max --ctag $c_\mathrm{src}$} per network) and cached under \texttt{paper\_experiments/mnist/<arch>\_exp/delta\_max/}. $\delta_{\max}$ is the sound upper bound on $\max_x N(x)[c_s] - \max_{k \ne c_s} N(x)[k]$ over the clean input box; rows where the pre-phase finished optimally show a bare value, rows where it hit \texttt{TIME\_LIMIT} show $\delta_{\max} \le Y$ (Gurobi upper bound). The two baselines \textsf{vaghar} (PI=off, no boosts) and \textsf{pi} (PI=on, no boosts) each pool together the standalone vaghar baseline runs (\texttt{vagharNoPerturbed\_*} / \texttt{vagharWithPerturbed\_*}) \emph{and} the \texttt{stdBoost} cells with all options off (zono=off, sg=off, tau=0 and matching pi value), since those cells encode an identical MIP and only differ in Gurobi seed. The remaining columns are the actual boosts. In the column labels, \textsf{zono} stands for \tech{nn1\_zono\_bounds}, \textsf{sg} for \tech{nn1\_sibling\_gate}, \textsf{pi} for \cli{use\_perturbed\_intervals}, and \textsf{tau=$x$} is \tech{nn1\_relax\_threshold}. Combinations the sweep filter excludes ((pi=off, tau$>0$); see \texttt{run\_relaxation\_sweep.py:2854}) appear as \textsf{---}. The two rightmost columns \textsf{adv+zono+prev\_pgd+sg+tau=0.0} and \textsf{adv+zono+prev\_pgd+sg+tau=0.5} report the advstd N2 transfer-mode runs for the two \texttt{zono:prev\_pgd:0.0+sg} and \texttt{zono:prev\_pgd:0.5+sg} combinations (loaded directly from the per-cell advstd CSVs that back Section~\ref{sec:safe}); these rows only populate on the $N_2$ block since advstd is a transfer technique. In each row, every winning combo's three sub-cells are shaded \cellcolor{green!25}~light~green: a combo wins if its mean $t$ ties the row-minimum (at the displayed 0.1-min precision) \emph{and} its underlying cells did \emph{not} all hit \texttt{TIME\_LIMIT}; if every combo on the row is timed out, winners are instead all combos sharing the smallest $\delta_u - \delta_l$ gap.}
