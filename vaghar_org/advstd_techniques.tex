...
\hline
\rowcolor{blue!12}   2 & zono        & prev\_pgd & 0.5+sg & \textbf{1.363} &   222 &    403 & \textbf{55.09\%} & \texttt{<{3x10,\discretionary{}{}{}cnn1},\discretionary{}{}{}translation,\discretionary{}{}{}3,\discretionary{}{}{}3>}; \texttt{<3x10,\discretionary{}{}{}translation,\discretionary{}{}{}1,\discretionary{}{}{}1>}; \texttt{<3x10,\discretionary{}{}{}translation,\discretionary{}{}{}3,\discretionary{}{}{}1>} & \texttt{<cnn1,\discretionary{}{}{}1>}\textsuperscript{*}; \texttt{<3x50,\discretionary{}{}{}1>}\textsuperscript{*}~\textit{(tied at TIME\_LIMIT)}; \texttt{<{3x50,\discretionary{}{}{}cnn1},\discretionary{}{}{}2>}\textsuperscript{*}~\textit{(tied at TIME\_LIMIT)}; \texttt{<3x50,\discretionary{}{}{}0>}~\textit{(tied at TIME\_LIMIT)} \\
\hline
\end{tabular}%
\end{adjustbox}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{3x50} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=51$ cells.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,1.00\,(1/1) ~ \textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,1.00\,(1/1)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.20) node[left]{$\overline{\text{sp}}$};
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{3x50} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=51$ cells, $n_{\max}=26$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,92\%\,(0f+23t/25) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,81\%\,(0f+21t/26)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  ...
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,2.885);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,2.885);
  \fill[white] (1.02,0.000) rectangle (1.48,2.654);
  \fill[red!75!black, opacity=0.25] (1.02,0.000) rectangle (1.48,2.654);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.000) rectangle (1.48,2.654);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.000) rectangle (1.48,2.654);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,2.905) {92\%};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
  \node[font=\small, text=orange!85!black] at (1.25,3.93) {$\bigstar$};
\end{tikzpicture}
\end{center}
\end{minipage}
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=156$ cells.\\[0.4ex]
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{linf} (p\_sizes merged: \texttt{0.1}) \textbar{} 2 combos, total $n=156$ cells, $n_{\max}=79$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,76\%\,(12f+48t/79) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,68\%\,(15f+37t/77)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=79$};
  \node[left, font=\tiny] at (0,0.75) {20};
  \node[left, font=\tiny] at (0,1.50) {40};
  \node[left, font=\tiny] at (0,2.25) {59};
  \node[left, font=\tiny] at (0,3.00) {79};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.924);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.924);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,0.570);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,0.570);
  \fill[white] (0.33,0.570) rectangle (0.78,1.975);
  \fill[blue!75!black, opacity=0.25] (0.33,0.570) rectangle (0.78,1.975);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,0.570) rectangle (0.78,1.975);
  \draw[gray!50!black, line width=0.2pt] (0.33,0.570) rectangle (0.78,1.975);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.944) {68\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,0.456);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,0.456);
  \fill[white] (1.02,0.456) rectangle (1.48,2.278);
  \fill[red!75!black, opacity=0.25] (1.02,0.456) rectangle (1.48,2.278);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.456) rectangle (1.48,2.278);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.456) rectangle (1.48,2.278);
...
\begin{center}
\scriptsize
\colorbox{yellow!40}{\textbf{sp}}\;\textbf{ALL} \textbar{} pert \textbf{ALL} (p\_sizes merged: \texttt{0.1}, \texttt{1,1}, \texttt{1,14,14,3}, \texttt{3,1}, \texttt{3,3}, \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=802$ cells.\\[0.4ex]
...
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  ...
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[red!75!black] (1.02,0) rectangle (1.48,0.974);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,0.974);
  \fill[red!75!black, opacity=0.25] (1.02,0.974) rectangle (1.48,1.363);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,0.974) rectangle (1.48,1.363);
  \draw[gray!50!black, line width=0.2pt] (1.02,0.974) rectangle (1.48,1.363);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (1.20,1.413) {1.36};
  \node[anchor=east, rotate=90, font=\tiny, text=red!75!black, inner sep=1pt] at (1.25,-0.05) {zono $\bullet$ prev-PGD $\bullet$ 0.5+sg};
...
\begin{center}
\scriptsize
\colorbox{cyan!30}{\textbf{win}}\;\textbf{ALL} \textbar{} pert \textbf{ALL} (p\_sizes merged: \texttt{0.1}, \texttt{1,1}, \texttt{1,14,14,3}, \texttt{3,1}, \texttt{3,3}, \texttt{3,3,5}, \texttt{5,5,5}) \textbar{} 2 combos, total $n=802$ cells, $n_{\max}=403$.\\[0.4ex]
\textbf{Ranking (best $\to$ worst):}\ \textcolor{orange!85!black}{$\bigstar$}\textcolor{red!75!black}{\rule{0.55em}{0.55em}}\,71\%\,(152f+134t/403) ~ \textcolor{blue!75!black}{\rule{0.55em}{0.55em}}\,63\%\,(152f+101t/399)\\[0.4ex]
\begin{tikzpicture}[scale=0.62, every node/.style={font=\tiny}]
  \draw[->] (0,0) -- (1.85,0);
  \draw[->] (0,0) -- (0,4.05) node[left]{$n$};
  \draw[dashed, gray] (0,3.00) -- (1.85,3.00) node[right]{$n_{\max}=403$};
  \node[left, font=\tiny] at (0,0.75) {101};
  \node[left, font=\tiny] at (0,1.50) {202};
  \node[left, font=\tiny] at (0,2.25) {302};
  \node[left, font=\tiny] at (0,3.00) {403};
  \fill[gray!8] (0.33,0) rectangle (0.78,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (0.33,0) rectangle (0.78,3.000);
  \fill[gray!30] (0.33,0) rectangle (0.78,2.970);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,2.970);
  \fill[blue!75!black] (0.33,0) rectangle (0.78,1.132);
  \draw[gray!50!black, line width=0.2pt] (0.33,0) rectangle (0.78,1.132);
  \fill[white] (0.33,1.132) rectangle (0.78,1.883);
  \fill[blue!75!black, opacity=0.25] (0.33,1.132) rectangle (0.78,1.883);
  \fill[pattern=north east lines, pattern color=blue!75!black] (0.33,1.132) rectangle (0.78,1.883);
  \draw[gray!50!black, line width=0.2pt] (0.33,1.132) rectangle (0.78,1.883);
  \node[anchor=south west, rotate=60, font=\tiny, inner sep=1pt] at (0.50,2.990) {63\%};
  \node[anchor=east, rotate=90, font=\tiny, text=blue!75!black, inner sep=1pt] at (0.55,-0.02) {zono $\bullet$ prev-PGD $\bullet$ 0.0+sg};
  \fill[gray!8] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50, line width=0.2pt, dashed] (1.02,0) rectangle (1.48,3.000);
  \fill[gray!30] (1.02,0) rectangle (1.48,3.000);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,3.000);
  \fill[red!75!black] (1.02,0) rectangle (1.48,1.132);
  \draw[gray!50!black, line width=0.2pt] (1.02,0) rectangle (1.48,1.132);
  \fill[white] (1.02,1.132) rectangle (1.48,2.129);
  \fill[red!75!black, opacity=0.25] (1.02,1.132) rectangle (1.48,2.129);
  \fill[pattern=north east lines, pattern color=red!75!black] (1.02,1.132) rectangle (1.48,2.129);
  \draw[gray!50!black, line width=0.2pt] (1.02,1.132) rectangle (1.48,2.129);
...
\hline
\rowcolor{green!15}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &     1 &    21 & 3616.22 & 3621.67 & 0.998 & \textit{3614.74} & \textit{3618.25} & \textit{0.999} & \textit{0.77} \\
...
\hline
\rowcolor{orange!20}             &                      & zono        & prev\_pgd & 0.5+sg &     0 &         7 &                7 &   9.7749 & \textbf{8.2421} &   1.5328 \\
\hline
...
11 & N2, zono, $\tau$=0.5, SibGate & \textbf{1.195} & 95 & 144 & \textbf{66.0\%} \\
...
% auto-generated: archs=['cnn1', '3x50', '3x10'], dataset=mnist, total_cell_rows=4249
\begin{table}[!htbp]
\centering
\scriptsize
...
dataset: \texttt{mnist} & occ (3,3,5) & (1,2,6,7,8,9) & 21.8 & 21.9 & 9.4$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 22.9 & 22.9 & 2.5 & 23.2 & 23.3 & 2.0 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.3 & \cellcolor{green!25}1.8 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.3 & \cellcolor{green!25}1.8 & 23.2 & 23.3 & 2.1 & \cellcolor{green!25}23.2 & \cellcolor{green!25}23.3 & \cellcolor{green!25}1.8 & 23.2 & 23.3 & 2.0 & 23.2 & 23.3 & 2.0 & --- & --- & --- & --- & --- & --- \\
 ...
 & patch (1,14,14,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}23.2 & \cellcolor{green!25}26.0 & \cellcolor{green!25}6.7 & 22.1 & 25.8 & 8.3 & 22.1 & 25.8 & 8.3 & 22.1 & 25.8 & 8.3 & 22.1 & 25.8 & 8.2 & 22.1 & 25.8 & 8.2 & 21.7 & 27.1 & 25.6 & 21.7 & 27.1 & 25.6 & --- & --- & --- & --- & --- & --- \\
 & translation (1,1) & (1,2,6,7,8,9) & \cellcolor{green!25}98.5 & \cellcolor{green!25}99.5 & \cellcolor{green!25}5.7$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.4 & 99.4 & 16.0 & 98.4 & 99.4 & 16.0 & 98.4 & 99.4 & 15.7 & 98.4 & 99.4 & 15.8 & 98.4 & 99.4 & 18.0 & 98.4 & 99.4 & 13.6 & 98.2 & 99.3 & 33.6 & 98.2 & 99.3 & 30.4 & --- & --- & --- & --- & --- & --- \\
 ...
 & translation (3,3) & (1,2,4,6,7,8,9) & \cellcolor{green!25}98.7 & \cellcolor{green!25}99.6 & \cellcolor{green!25}7.2$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.1 & 99.2 & 18.2 & 98.1 & 99.2 & 17.8 & 98.1 & 99.3 & 19.1 & 98.1 & 99.3 & 18.3 & 98.1 & 99.2 & 15.7 & 98.1 & 99.3 & 19.0 & 97.9 & 99.1 & 34.8 & 97.9 & 99.1 & 35.2 & --- & --- & --- & --- & --- & --- \\
\hline
...
\hline
\textbf{cnn1/N2} & linf (0.1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 64.4 & 100.0 & 60.3 & 59.9 & 100.0 & 60.4 & 64.7 & 100.0 & 60.3 & 67.2 & 99.7 & 60.3 & 62.9 & 100.0 & 60.3 & 59.2 & 100.0 & 60.3 & 65.5 & 100.0 & 60.3 & 67.9 & 100.0 & 60.3 & 68.5 & 100.0 & 123.8 & \cellcolor{green!25}70.3 & \cellcolor{green!25}100.0 & \cellcolor{green!25}120.3 \\
...
dataset: \texttt{mnist} & occ (5,5,5) & (1,2,6,7,8,9) & 17.5 & 17.6 & 6.5$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 18.0 & 18.0 & 4.4 & 18.1 & 18.1 & 7.5 & 18.1 & 18.1 & 7.3 & 18.1 & 18.1 & 6.7 & 18.1 & 18.1 & 7.0 & 18.1 & 18.1 & 7.0 & 18.1 & 18.1 & 7.3 & 18.1 & 18.1 & 6.9 & \cellcolor{green!25}18.1 & \cellcolor{green!25}18.2 & \cellcolor{green!25}1.4 & 18.1 & 19.3 & 17.9 \\
 ...
 & translation (1,1) & (1,2,6,7,8,9) & \cellcolor{green!25}98.9 & \cellcolor{green!25}99.8 & \cellcolor{green!25}6.4$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.6 & 99.9 & 19.2 & 98.7 & 100.0 & 21.8 & 98.6 & 100.0 & 21.8 & 98.6 & 100.0 & 20.7 & 98.6 & 100.0 & 20.0 & 98.6 & 100.0 & 22.2 & 98.6 & 100.0 & 22.7 & 98.6 & 100.0 & 22.9 & 98.6 & 99.7 & 31.5 & 98.8 & 99.8 & 26.2 \\
 ...
 & translation (3,3) & (1,2,4,6,7,8,9) & \cellcolor{green!25}98.6 & \cellcolor{green!25}99.5 & \cellcolor{green!25}9.3$^*$ & --- & --- & --- & --- & --- & --- & --- & --- & --- & 98.2 & 99.8 & 21.8 & 98.2 & 100.0 & 18.6 & 98.2 & 100.0 & 19.6 & 98.2 & 100.0 & 20.7 & 98.2 & 100.0 & 19.2 & 98.2 & 99.4 & 20.0 & 98.2 & 100.0 & 18.0 & 98.2 & 100.0 & 19.6 & 98.1 & 99.2 & 31.6 & 98.5 & 100.0 & 49.7 \\
\hline
...
\hline
\textbf{3x50/N2} & linf (0.1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 48.5 & 96.6 & 60.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 52.8 & 94.7 & 116.8 & \cellcolor{green!25}54.4 & \cellcolor{green!25}94.4 & \cellcolor{green!25}120.3 \\
$c_s$=0 & occ (3,3,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 0.6 & 1.6 & 60.3 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 0.7 & 1.5 & 98.7 & \cellcolor{green!25}0.9 & \cellcolor{green!25}1.4 & \cellcolor{green!25}101.8 \\
$\delta_{\max}$=19.94, $\delta_d$=83.2\% & occ (5,5,5) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 6.3 & 13.2 & 60.2 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 6.7 & 12.6 & 101.9 & \cellcolor{green!25}7.7 & \cellcolor{green!25}12.4 & \cellcolor{green!25}100.3 \\
dataset: \texttt{mnist} & patch (1,14,14,3) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 57.1 & 76.0 & 60.3 & 57.3 & 75.7 & 60.3 & 57.1 & 75.9 & 60.3 & 56.9 & 76.2 & 60.3 & 57.3 & 75.8 & 60.4 & 57.0 & 75.6 & 60.4 & 57.2 & 75.3 & 60.4 & 57.2 & 75.7 & 60.4 & \cellcolor{green!25}57.7 & \cellcolor{green!25}73.1 & \cellcolor{green!25}91.2 & 57.6 & 74.0 & 96.3 \\
 & translation (1,1) &  & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 86.4 & 93.2 & 60.3 & 85.2 & 94.2 & 60.2 & 86.3 & 93.8 & 60.2 & 86.5 & 93.7 & 60.2 & 84.4 & 94.4 & 60.3 & 85.5 & 94.1 & 60.3 & 85.8 & 93.9 & 60.3 & 85.7 & 94.0 & 60.2 & 86.9 & 92.3 & 120.3 & \cellcolor{green!25}87.0 & \cellcolor{green!25}91.9 & \cellcolor{green!25}117.2 \\
 & translation (3,1) & (3,4,5,6,7,8,9) & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & \cellcolor{green!25}96.2 & \cellcolor{green!25}97.6 & \cellcolor{green!25}20.0 & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & --- & 93.3 & 96.7 & 41.5$^*$ & --- & --- & --- & 95.9 & 97.4 & 35.3 & 95.9 & 97.4 & 31.1 \\
