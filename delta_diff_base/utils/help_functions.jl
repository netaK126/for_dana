...
function save_results(results_path, model_name, perturbation, perturbation_size, results_str, d, ss, tt, w_, h_, k_)

    file = open(results_path * model_name * "_" * perturbation * "_" * create_perturbation_string(perturbation_size)*"DeltaDiffVerification.txt", "w")
